...
- **179 habitat objects** and **150 recipes** across habitat, structures & decor, paths, storage, camp comforts, and restoration kits. Plantable flowers/grasses/trees are **planted, not crafted**, so 136 of the recipes are craftable items and the remaining 14 are the plant set.
