...
- **436 habitat objects** and **406 recipes** across habitat, structures & decor, paths, storage, camp comforts, and restoration kits. Plantable flowers/grasses/trees are **planted, not crafted**, so 392 of the recipes are craftable items and the remaining 14 are the plant set.
...
- **A home you can step inside, decorate, and upgrade.** Walk up to your camp tent in Willow Meadow and press **E** to step inside. Decorate with **91** indoor-only **"camp comfort"** items — sleeping bag, rug, lamp, house plant, hammock, string lights, armchair, fireplace, bookshelf, rocking chair, terrarium, firewood rack and more. **Thirty-three of them hang on the walls** and can go nowhere else: framed landscapes, a wall clock, wreaths, a moss wall garden, a driftwood mirror, a dragonfly mobile, both chandeliers. Hanging space is the back wall and the two side walls (not the corners, and not the door wall) — a tile you hang something on is a tile the Warmth track leaves unwindowed, so the wall is yours to arrange. **You can sit in any of it** — armchairs, stools, a rocking chair, floor cushions, a toadstool, a moss pouf, and the benches and picnic blankets out in the preserve — by walking up and pressing **E**; any step gets you back on your feet. And **tables, dressers and shelf tops hold one small ornament each**: a house plant, a snow globe, a model boat, the cocoa warmer. A surface carrying something can't be moved or picked up until you take the ornament off it. First you **build** your home in one of three styles — **Log Cabin** (wood), **Meadow Cottage** (fiber & flowers), or **Stone Hearth** (stone) — which sets its look for good, and a **Cozy Bed is craftable the moment it is built**; then upgrade along four tracks: **Space**, **Comfort** (a flat carry-capacity perk), **Furnishings**, and **Warmth**. Some bigger pieces need a proper house, not the starter tent.
