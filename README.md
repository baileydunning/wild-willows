...
- **384 habitat objects** and **354 recipes** across habitat, structures & decor, paths, storage, camp comforts, and restoration kits. Plantable flowers/grasses/trees are **planted, not crafted**, so 340 of the recipes are craftable items and the remaining 14 are the plant set.
