import{r as fa,s as pa,t as h,i as mt,w as Ht,g as wa,W as ga,S as ya,n as Ue,a as ba,b as Nt,d as va,c as Lt,e as ka,o as xa,f as Sa,h as Aa,j as Ia,k as Ma,l as $a,m as Ta}from"./index-BvG4smd2.js";fa("en",{server:pa});const Pa=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
function render(data) {
	...
	const acqEd = (s.acquisition || {}).editions || {};
	...
	const installDonut = donut([
		{ label: "Full", value: acqEd.full, color: "#4a7c46" },
		{ label: "Demo", value: acqEd.demo, color: "#d9a441" },
	].filter((x) => x.value));
	const vsRows = [
	...
	out.push(sec("Editions · demo vs full", "how the free demo compares to the full game", \`<div class="grid two">\` +
		cardTitled("Caretakers by edition", "who is playing", playersDonut) +
		(installDonut.includes("donutwrap") ? cardTitled("Installs by edition", "per device", installDonut) : "") +
		\`</div><div class="card" style="margin-top:.8rem"><h3>Every metric, side by side<span class="tag">demo vs full</span></h3>\` +
