import{_ as e,a as t,b as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,t as g,u as _,v,x as y,y as b}from"./index-G4M_W7jG.js";b(`en`,{server:y});var x=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,T=`0.2.1+2026-08-03T04:27:49.105Z`,ee=class{constructor(e){this.buf=e}get length(){return this.buf.length}toString(e=`hex`){if(e===`base64`){let e=``;for(let t of this.buf)e+=String.fromCharCode(t);return typeof btoa<`u`?btoa(e):e}if(e===`utf8`)return new TextDecoder().decode(this.buf);let t=``;for(let e of this.buf)t+=e.toString(16).padStart(2,`0`);return t}at(e){return this.buf[e]}};function te(e){let t=new Uint8Array(e),n=globalThis;if(n.crypto?.getRandomValues)n.crypto.getRandomValues(t);else for(let n=0;n<e;n++)t[n]=Math.floor(Math.random()*256);return t}function ne(e){return new ee(te(e))}function re(e,t,n){let r=`${t}::${e}`,i=new Uint8Array(n),a=2166136261;for(let e=0;e<n;e++){let t=r.charCodeAt(e%r.length)||e+1;a^=t,a=Math.imul(a,16777619)>>>0,a^=a>>>13,i[e]=(a^e*2654435761)&255}return new ee(i)}function ie(e,t){let n=e?.length??0;if(n!==(t?.length??-1))return!1;let r=0;for(let i=0;i<n;i++){let n=typeof e.at==`function`?e.at(i):e[i],a=typeof t.at==`function`?t.at(i):t[i];r|=n^a}return r===0}var ae=v.records.map(e=>e.id);function E(e){return Math.max(0,Math.round((q(e)?.playSeconds||0)*1e3)+(e?.clockOffsetMs||0))}var D=()=>{let e=typeof databases<`u`&&databases?databases.wildwillows:null;if(!e||!e.Player)throw new O(n(`server.err.dbStarting`),503);return e},O=class extends Error{constructor(e,t=400){super(e),this.statusCode=t}},k=(e,t,n)=>Math.max(t,Math.min(n,e));function oe(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0}function se(e){let t=e>>>0;return()=>{t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function ce(e,t){let r=Number(e);if(!Number.isInteger(r)||r<=0)throw new O(n(`server.err.positiveWholeNumber`,{label:t}));return r}function A(e){return e?Object.values(e).reduce((e,t)=>e+(t||0),0):0}function le(e){return/end of buffer|buffer not reached|decod/i.test(String(e?.message||e))}async function ue(e,t){try{return await e.delete(t),!0}catch(e){if(!le(e))throw e}try{return await e.put({id:t}),await e.delete(t),!0}catch{return!1}}async function j(e,t){try{let n=await e.get(t);if(n)try{JSON.stringify({...n})}catch(e){if(le(e))throw e}return n}catch(n){if(le(n))return await ue(e,t),console.error(`purged undecodable record: ${t}`),null;throw n}}async function de(e){let t=[];try{for await(let n of e)t.push(n)}catch(e){console.error(`scan: skipping undecodable record(s) —`,e?.message||e)}return t}async function M(e){return!e||typeof e.search!=`function`?[]:de(e.search({}))}async function N(e,t){return!e||typeof e.search!=`function`?[]:(await de(e.search({}))).filter(e=>e?.playerId===t)}function P(e){return e?.worldId||e?.id}async function F(e,t){return!e||typeof e.search!=`function`?[]:(await de(e.search({}))).filter(e=>(e?.worldId??e?.playerId)===t)}async function fe(e,t,n){return(await F(e,t)).find(e=>e.id===n)||null}async function I(e,t,n,r,i){return(await F(e,t)).find(e=>e.area===n&&e.x===r&&e.y===i)||null}async function pe(e,t,n){return(await F(e,t)).find(e=>e.biomeId===n)||null}async function me(e,t,n){return(await F(e,t)).find(e=>e.animalId===n)||null}function he(){let e=``;for(let t=0;t<6;t++)e+=`ABCDEFGHJKLMNPQRSTUVWXYZ23456789`[Math.floor(Math.random()*32)];return e}var L=6;async function R(e,t={}){let r=D(),i=e.id;await r.World.get(i)||await r.World.put({id:i,name:e.name?n(`server.world.soloName`,{name:e.name}):n(`server.world.mySoloName`),solo:!0,ownerId:e.id,joinCode:null,createdAt:e.createdAt||Date.now(),maxMembers:1,meadowShift:t.freshGrid?Ze:0,meadowShiftY:t.freshGrid?Qe:0});let a=`${i}:${e.id}`;await r.WorldMember.get(a)||await r.WorldMember.put({id:a,worldId:i,playerId:e.id,role:`owner`,joinedAt:e.createdAt||Date.now(),lastSeenAt:Date.now()}),e.worldId||await r.Player.patch(e.id,{worldId:i}),t.freshGrid||await $e(i)}async function ge(e){let t=D(),n=await N(t.WorldMember,e),r=[];for(let i of n){let n=await t.World.get(i.worldId);if(!n)continue;let a=(await F(t.WorldMember,n.id)).length;r.push({worldId:n.id,name:n.name,solo:!!n.solo,role:i.role,joinCode:n.solo?null:n.joinCode,memberCount:a,maxMembers:n.maxMembers||L,isOwner:n.ownerId===e})}return r.sort((e,t)=>e.solo===t.solo?0:e.solo?-1:1)}async function _e(e,t){let n=D(),r=await n.Player.get(e);if(!r)return[];let i=r.unlockedBiomes||[`meadow`];if(t===r.id)return i;let a=await F(n.BiomeState,t),o=new Set(i);for(let e of a)e.unlocked&&o.add(e.biomeId);let s=[...o];return s.length!==i.length&&await n.Player.patch(e,{unlockedBiomes:s}),s}var z=!1;async function ve(){if(z)return;z=!0;let t=D(),n=[[t.Biome,v.records],[t.Recipe,e.records],[t.HabitatObject,o.records],[t.ToolDef,s.records],[t.ResourceType,u.records],[t.Animal,[...p.records,...a.records]],[t.Achievement,i.records]];for(let[e,t]of n){let n=new Set(t.map(e=>e.id));for(let t of await de(e.search({})))n.has(t.id)||await e.delete(t.id);for(let n of t)await e.put(n)}}var ye=null;async function B(){if(await ve(),!ye){let e=D(),[t,n,r,i,a,o,s]=await Promise.all([M(e.Biome),M(e.Animal),M(e.ResourceType),M(e.Recipe),M(e.HabitatObject),M(e.ToolDef),M(e.Achievement)]),c=e=>new Map(e.map(e=>[e.id,e]));s.sort((e,t)=>(e.order||0)-(t.order||0)),ye={biomes:t,animals:n,resources:r,recipes:i,objects:a,tools:o,achievements:s,biome:c(t),animal:c(n),resource:c(r),recipe:c(i),object:c(a),tool:c(o),achievement:c(s)}}return ye}var be=75,xe=5,V=`grasshopper`,Se=100,Ce={biome:`meadow`,minHealth:30},H={cabin:{name:`Log Cabin`,floor:`#c8a064`,wall:`#5e3f29`,accent:`#b5707a`,materials:{branches:16,fiber:6},requires:Ce,perk:{id:`forage`,base:.1,perLevel:.05,cap:.6}},cottage:{name:`Meadow Cottage`,floor:`#e6d3a6`,wall:`#aab9c6`,accent:`#7fae6a`,materials:{wildflowers:6,fiber:10,clay:4},requires:Ce,perk:{id:`growth`,base:.1,perLevel:.04,cap:.5}},stone:{name:`Stone Hearth`,floor:`#a9a499`,wall:`#6f6a62`,accent:`#d98a4f`,materials:{stones:14,clay:6},requires:Ce,perk:{id:`thrift`,base:.1,perLevel:.05,cap:.6}}},we={style:`cabin`,space:1,comfort:1,decor:1,light:1,styleLocked:!1},U={space:{name:`Space`,blurb:`A bigger room with more floor to decorate.`,levels:[{inner:{w:6,h:5}},{inner:{w:8,h:6},materials:{branches:12,fiber:8},requires:{biome:`meadow`,minHealth:30}},{inner:{w:10,h:7},materials:{branches:18,stones:6,clay:6},requires:{biome:`forest`,minHealth:45}},{inner:{w:12,h:9},materials:{branches:24,clay:10,"clean-water":6},requires:{biome:`wetland`,minHealth:55}}]},comfort:{name:`Comfort`,blurb:`Carry more on every gathering trip (+capacity).`,levels:[{carry:0},{carry:45,materials:{fiber:10,branches:4},requires:{biome:`meadow`,minHealth:35}},{carry:95,materials:{fiber:14,moss:6},requires:{biome:`forest`,minHealth:50}},{carry:160,materials:{reeds:10,fiber:12},requires:{biome:`wetland`,minHealth:60}}]},decor:{name:`Furnishings`,blurb:`A finer rug and wall trim in your style.`,levels:[{},{materials:{fiber:8,wildflowers:4}},{materials:{fiber:12,berries:6},requires:{biome:`meadow`,minHealth:50}},{materials:{fiber:16,clay:6},requires:{biome:`forest`,minHealth:55}}]},light:{name:`Warmth`,blurb:`Windows and a warm hearth glow.`,levels:[{},{materials:{branches:6,stones:4}},{materials:{stones:8,clay:4},requires:{biome:`forest`,minHealth:45}},{materials:{clay:6,"clean-water":4},requires:{biome:`wetland`,minHealth:55}}]}};function W(e){if(e?.home)return{...we,...e.home};let t=e?.homeTier||1;return{...we,space:t,comfort:t,styleLocked:t>1}}var Te=e=>U.comfort.levels[(W(e).comfort||1)-1]?.carry||0,Ee=5;function De(e){let t=W(e);if(!t.styleLocked)return null;let n=H[t.style]?.perk;if(!n)return null;let r=(t.space||1)+(t.comfort||1)+(t.decor||1)+(t.light||1),i=Math.min(n.cap,n.base+n.perLevel*Math.max(0,r-Ee));return{id:n.id,strength:i}}function Oe(e){let t=U.space.levels[(W(e).space||1)-1]?.inner||{w:8,h:6},n=Math.floor((pt-t.w)/2),r=Math.floor((mt-t.h)/2);return{x0:n,y0:r,x1:n+t.w-1,y1:r+t.h-1}}var ke={w:6,h:5};function Ae(e){let t=/^tent-([a-z][a-z-]*)$/.exec(String(e||``));return t?t[1]:null}function je(){let e=Math.floor((pt-ke.w)/2),t=Math.floor((mt-ke.h)/2);return{x0:e,y0:t,x1:e+ke.w-1,y1:t+ke.h-1}}var Me=.75,Ne={1:200,2:350,3:550,4:800},Pe={water:6,wildflowers:1},Fe={basket:1,shovel:1,"watering-can":1,"field-journal":1},Ie=[`#f6d7b8`,`#eec39a`,`#d9a06b`,`#b97f50`,`#8d5a3a`,`#6b4226`],Le=[`#3b2e25`,`#6e4a33`,`#a3692f`,`#c9913f`,`#d9b380`,`#8c8c8c`],Re=[`#4a7c59`,`#7a9ac0`,`#b5707a`,`#c9913f`,`#7d6b9e`,`#5d8a8a`],ze=[`straw`,`leaf`,`beanie`,`cap`,`bucket`,`flower`,`party`,`ranger`,`mushroom`,`wizard`,`crown`,`bandana`,`none`],Be=[`#c9a35c`,`#b5707a`,`#5f86b0`,`#5d8a4a`,`#7d6b9e`,`#b05555`],Ve=[`short`,`bald`,`long`,`bob`,`curly`,`curly-long`,`bun`,`braid`,`ponytail`,`pigtails`,`afro`,`mohawk`],He=[`none`,`beard`],Ue=[`slim`,`round`];function We(e,t){return typeof e==`string`&&/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e.trim())?e.trim().toLowerCase():t}function Ge(e){return e||={},{skin:We(e.skin,Ie[1]),hair:We(e.hair,Le[1]),outfit:We(e.outfit,Re[0]),hat:ze.includes(e.hat)?e.hat:`straw`,hatColor:typeof e.hatColor==`string`&&/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e.hatColor.trim())?e.hatColor.trim().toLowerCase():null,hairstyle:Ve.includes(e.hairstyle)?e.hairstyle:`short`,beard:He.includes(e.beard)?e.beard:`none`,body:Ue.includes(e.body)?e.body:`slim`}}function Ke(e){if(!e)return e;let{passcode:t,passcodeHash:n,passcodeSalt:r,...i}=e;return i.metrics!==void 0&&(i.metrics=q(e)),i.daily!==void 0&&(i.daily=nt(e)),i}function qe(e,t){let n=t||ne(16).toString(`hex`);return{salt:n,hash:re(String(e),n,32).toString(`hex`)}}function Je(e,t,n){try{let r=globalThis.Buffer,i=re(String(e),t,32),a=r.from(n,`hex`);return i.length===a.length&&ie(i,a)}catch{return!1}}async function Ye(e,t){let n=String(t||``);if(e.passcodeHash&&e.passcodeSalt)return Je(n,e.passcodeSalt,e.passcodeHash);if(typeof e.passcode==`string`&&n.length>0&&n===e.passcode){let{salt:t,hash:r}=qe(n);return await D().Player.patch(e.id,{passcodeHash:r,passcodeSalt:t,passcode:null}),!0}return!1}function Xe(e){return String(e).trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}var G={x:23,y:5,size:`small-chest`,capacity:120},Ze=14,Qe=0;async function $e(e){let t=D(),n=await j(t.World,e);if(!n)return!1;let r=typeof n?.meadowShift==`number`?n.meadowShift:0,i=typeof n?.meadowShiftY==`number`?n.meadowShiftY:0,a=Ze-r,o=Qe-i;if(a!==0||o!==0){for(let n of[t.Placement,t.TerrainTile,t.Chest])for(let t of await F(n,e))t.area===`meadow`&&await n.patch(t.id,{x:(Number(t.x)||0)+a,y:(Number(t.y)||0)+o});for(let n of await F(t.WorldMember,e)){let r=await j(t.Player,n.playerId);r?.area===`meadow`&&P(r)===e&&await t.Player.patch(r.id,{x:(Number(r.x)||0)+a,y:(Number(r.y)||0)+o})}}return n&&(r!==Ze||i!==Qe)&&await t.World.patch(e,{meadowShift:Ze,meadowShiftY:Qe}),a!==0||o!==0}async function K(e){if(!e||typeof e!=`string`)throw new O(n(`server.err.playerIdRequired`));let t=await j(D().Player,e);if(!t)throw new O(n(`server.err.noSaveLogin`),404);return{player:t}}function et(e){return{firstSeenAt:e,lastSeenAt:e,lastHeartbeatAt:0,playSeconds:0,sessions:0,counts:{},areaSeconds:{},curSessionSeconds:0,sessionLengths:{},firstActionAt:0,creationMs:0}}function q(e){let t=e?.metrics;if(t==null)return null;if(typeof t==`string`)try{return JSON.parse(t)}catch{return null}return t}function tt(e){return JSON.stringify(e??{})}function nt(e){let t=e?.daily;if(t==null)return null;if(typeof t==`string`)try{return JSON.parse(t)}catch{return null}return t}function rt(e){return JSON.stringify(e??{})}var it=new Set([`recolors`,`appearanceChanges`]);function at(e){let t=e/60;return t<2?`<2m`:t<10?`2-10m`:t<30?`10-30m`:`30m+`}async function J(e,t={},n={}){if(!e?.id)return null;let r=Object.entries(t).filter(([,e])=>e),i=Object.entries(n).filter(([,e])=>e);if(!r.length&&!i.length)return q(e);let a=Date.now(),o=await D().Player.get(e.id)||e,s=q(o)||et(o.createdAt||a),c={...s.counts||{}};for(let[e,t]of r)c[e]=(c[e]||0)+t;let l={...s,counts:c,lastSeenAt:a};!s.firstActionAt&&r.some(([e,t])=>t&&!it.has(e))&&(l.firstActionAt=a);let u={metrics:tt(l)};if(i.length){let e=ut(o,a),t=nt(o),n={...(t?.dayKey===e?t:{dayKey:e,counts:{}}).counts||{}};for(let[e,t]of i)n[e]=(n[e]||0)+t;u.daily=rt({dayKey:e,counts:n})}return await D().Player.patch(e.id,u),l}var ot=864e5,st=4,ct=e=>(Number.isFinite(e?.tzOffsetMinutes)?e.tzOffsetMinutes:0)*6e4,lt=e=>{let t=Math.round(Number(e));return Number.isFinite(t)?k(t,-840,840):0};function ut(e,t){return Math.floor((t+ct(e)-st*36e5)/ot)}var Y=e=>Math.round(e*10)/10;function dt(e){let t=Date.now(),n=q(e)||et(e.createdAt||t),r=n.playSeconds||0,i=n.sessions||0,a=n.counts||{},o=Object.entries(a).reduce((e,[t,n])=>e+(it.has(t)?0:n||0),0),s=e.createdAt||n.firstSeenAt||t,c=n.lastSeenAt||null,l=n.areaSeconds||{},u={};for(let[e,t]of Object.entries(l))u[e]=Math.round((t||0)/60);let d=Object.entries(l).sort((e,t)=>(t[1]||0)-(e[1]||0))[0]?.[0]||null,f=n.firstActionAt||0,p=f?Y((f-s)/1e3):null,m=n.creationMs||0,h=c?Y((t-c)/36e5):null,g=Math.floor((t-s)/ot),_=`dormant`;return h!=null&&(h<=24?_=`active`:h<=168&&(_=`recent`)),{playerId:e.id,name:e.name,createdAt:s,firstSeenAt:n.firstSeenAt||s,lastSeenAt:c,daysSinceJoined:g,hoursSinceActive:h,status:_,isNewToday:t-s<=ot,language:n.language||null,sessions:i,playSeconds:r,playMinutes:Math.round(r/60),avgSessionMinutes:i?Math.round(r/60/i):0,totalActions:o,actionsPerSession:i?Y(o/i):0,actionsPerMinute:r>0?Y(o/(r/60)):0,tutorialStep:e.tutorialStep||0,currentArea:e.area||null,unlockedBiomes:(e.unlockedBiomes||[]).length,areaSeconds:l,areaMinutes:u,mostTimeArea:d,sessionLengths:n.sessionLengths||{},timeToFirstActionSeconds:p,creationMs:m,creationSeconds:m?Y(m/1e3):null,appearance:e.appearance||null,counts:a}}function ft(e,t,n){let r=e.counts||{};return{collected:(r.resourcesCollected||0)>0,terraformed:(r.terraformActions||0)>0,planted:(r.plantsPlanted||0)>0,crafted:(r.itemsCrafted||0)>0||Object.keys(n.craftedEver||{}).length>0,placed:(r.objectsPlaced||0)>0,attractedAnimal:(t?.totalAnimalsReturned||0)>0,upgradedTool:(r.toolsUpgraded||0)>0,builtHome:(r.homesBuilt||0)>0,upgradedHome:(r.homeUpgrades||0)>0,unlockedSecondBiome:(e.unlockedBiomes||0)>=2}}var pt=30,mt=20,ht=8;function gt(e,t){let n=t===`home`?null:e.biome.get(t)?.grid;return{cols:n?.cols||pt,rows:(n?.rows||mt)+(t===`alpine`?ht:0)}}var _t={tilled:`#8a6a48`,watered:`#6b4f33`,water:`#5d96c8`};function vt(e,t,n){let r=parseInt(e.slice(1),16),i=parseInt(t.slice(1),16),a=e=>{let t=r>>e&255,a=i>>e&255;return Math.round(t+(a-t)*k(n,0,1))};return`#`+[a(16),a(8),a(0)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}var yt=e=>String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`);function bt(e,t,n,r,i){let a=gt(e,t?.id||``),o=a.cols*16+16,s=a.rows*16+16+22,c=t?.palette?.damaged||`#b9a37c`,l=t?.palette?.healthy||`#8fbf6f`,u=vt(c,l,n/100),d=vt(c,l,n/100*.8),f=e=>8+e*16,p=e=>8+e*16,m=[];m.push(`<rect x="0" y="0" width="${o}" height="${s}" rx="10" fill="${u}"/>`);for(let e=0;e<a.rows;e++)for(let t=0;t<a.cols;t++)(t+e)%2==0&&m.push(`<rect x="${f(t)}" y="${p(e)}" width="16" height="16" fill="${d}" opacity="0.22"/>`);for(let e of i){let t=_t[e.type];t&&m.push(`<rect x="${f(e.x)}" y="${p(e.y)}" width="16" height="16" rx="3" fill="${t}"/>`)}for(let t of r){let n=e.object.get(t.objectId)?.color||`#6b5a3a`;m.push(`<circle cx="${f(t.x)+16/2}" cy="${p(t.y)+16/2}" r="6.72" fill="${n}" stroke="#2b3321" stroke-opacity="0.35"/>`)}return m.push(`<rect x="0" y="${s-22}" width="${o}" height="22" fill="#2b3321" opacity="0.55"/>`),m.push(`<text x="8" y="${s-7}" font-family="sans-serif" font-size="12" fill="#fdfaf0">${yt(t?.name||`Area`)} — ${n}% health · ${r.length} placed</text>`),`<svg xmlns="http://www.w3.org/2000/svg" width="${o}" height="${s}" viewBox="0 0 ${o} ${s}">${m.join(``)}</svg>`}function xt(e){return`data:image/svg+xml;base64,`+globalThis.Buffer.from(e,`utf8`).toString(`base64`)}async function St(e,t={}){let n=D(),r=await B(),i=await N(n.BiomeState,e),a=new Map(i.map(e=>[e.biomeId,e])),o=t.images?await N(n.Placement,e):[],s=t.images?await N(n.TerrainTile,e):[],c=r.biomes.map(e=>{let n=a.get(e.id)||{},i={biomeId:e.id,name:e.name,health:n.health||0,balance:n.balance||0,returnedCount:n.returnedCount||0,unlocked:!!n.unlocked,explorable:!!e.explorable};if(t.images&&n.unlocked){let t=o.filter(t=>t.area===e.id),n=s.filter(t=>t.area===e.id);i.placements=t.length,i.snapshot=xt(bt(r,e,i.health,t,n))}return i});return{biomes:c,summary:Ct(c)}}function Ct(e){let t=e.filter(e=>e.unlocked);return{biomesUnlocked:t.length,biomesFullyRestored:t.filter(e=>(e.health||0)>=100).length,avgHealth:t.length?Math.round(t.reduce((e,t)=>e+(t.health||0),0)/t.length):0,totalAnimalsReturned:e.reduce((e,t)=>e+(t.returnedCount||0),0)}}async function wt(e,t,n,r,i=0,a=0,o=`full`){let s=D(),c=await B(),l=Date.now(),{salt:u,hash:d}=qe(n),f={id:e,name:t,passcodeSalt:u,passcodeHash:d,appearance:r,tzOffsetMinutes:i,createdAt:l,clockOffsetMs:h(0,`day`),worldId:e,area:`meadow`,x:24.5,y:6.5,inventory:{...Pe},craftedItems:{},tools:{...Fe},unlockedBiomes:[`meadow`],visitedBiomes:[`meadow`],tutorialStep:0,home:{...we},metrics:tt({...et(l),creationMs:a>0?Math.round(a):0,edition:o}),customGoals:[]};await s.Player.put(f);let p=e,m=c.biomes.map(t=>({id:`${p}:${t.id}`,worldId:p,playerId:e,biomeId:t.id,health:xe,balance:0,returnedCount:0,unlocked:t.id===`meadow`}));for(let e of m)await s.BiomeState.put(e);let g=`pl_${e}_starter-chest`,_=[{id:g,worldId:p,playerId:e,objectId:`small-chest`,area:`meadow`,x:G.x,y:G.y,placedAt:l}];for(let e of _)await s.Placement.put(e);let v={id:g,worldId:p,playerId:e,area:`meadow`,x:G.x,y:G.y,size:`small-chest`,capacity:G.capacity,contents:{}};return await s.Chest.put(v),{player:f,seeded:{biomeStates:m,placements:_,chests:[v]}}}async function Tt(e){let t=Date.now(),n=await B(),r=e.player?.worldId||e.player?.id,i=E(e.player);return{player:Ke(e.player),biomeStates:e.seeded.biomeStates,placements:e.seeded.placements,chests:e.seeded.chests,discoveries:[],nodeStates:[],terrain:[],achievements:[],feed:[],serverTime:t,weather:l(r,i,ae),dailyTasks:xn({wid:r,player:e.player,d:n,discoveries:[],biomeStates:e.seeded.biomeStates,placements:e.seeded.placements,chests:e.seeded.chests,now:t}),customGoals:e.player.customGoals||[],goalLimit:nn(e.player,n),nodeRegenSeconds:be,inventoryCapacity:Et(e.player)}}function Et(e){return(Ne[e.tools?.basket||1]||200)+Te(e)}function Dt(e,t){let n=Date.now(),r={};for(let i of e){if(t&&i.plantedAt){let e=(t.object.get(i.objectId)?.growSeconds||0)*1e3;if(e>0&&n-i.plantedAt<e)continue}r[i.objectId]=(r[i.objectId]||0)+1}return r}var Ot=90;function kt(e){let t=95*(1-Math.exp(-Math.max(0,e)/Ot));return k(Math.round(xe+t),0,100)}var At=[{animals:5,cap:60},{animals:10,cap:75},{animals:15,cap:88}];function jt(e){for(let t of At)if(e<t.animals)return t.cap;return 100}function Mt(e){return(e?.matureHours||0)*36e5}function Nt(e,t,n){let r=Mt(e);return r>0&&n-(t.placedAt||0)>=r}function Pt(e,t,n,r){let i=Mt(e);if(i<=0)return!1;let a=(t.placedAt||0)+i;return a>n&&a<=r}var Ft=8;function It(e,t,n=0,r=Date.now()){let i=0,a=0;for(let n of t){let t=e.object.get(n.objectId);t&&(i+=t.healthValue||0,Nt(t,n,r)&&(a+=t.matureBonus||0))}return i+=Math.min(a,Ft),n>0&&(i+=2*Math.min(n,7)),i}var Lt=.45,Rt=.35,zt=.2;function Bt(e,t,n){let r=e.animals.filter(e=>e.biome===t),i=r.length;if(i===0)return 0;let a=r.filter(e=>n.has(e.id));if(a.length>=i)return 100;let o=a.length/i,s=r.filter(e=>(e.requirements?.animals||[]).length>0),c=s.filter(e=>n.has(e.id)).length,l=s.length?c/s.length:1,u=new Set(r.map(e=>e.kind)),d=new Set(a.map(e=>e.kind)),f=u.size?d.size/u.size:0,p=Lt*o+Rt*l+zt*f;return k(Math.round(p*100),0,99)}function Vt(e,t=!1){let n=new Set(e.filter(e=>e.type===`water`&&(!t||!e.seeded)).map(e=>`${e.x},${e.y}`)),r=new Set,i=0,a=0;for(let e of n){if(r.has(e))continue;let t=[e];r.add(e);let o=0,s=1/0,c=-1/0,l=1/0,u=-1/0;for(;t.length;){let[e,i]=t.pop().split(`,`).map(Number);o++,s=Math.min(s,e),c=Math.max(c,e),l=Math.min(l,i),u=Math.max(u,i);for(let[a,o]of[[1,0],[-1,0],[0,1],[0,-1]]){let s=`${e+a},${i+o}`;n.has(s)&&!r.has(s)&&(r.add(s),t.push(s))}}i=Math.max(i,o),a=Math.max(a,Math.max(c-s+1,u-l+1))}return{tiles:n.size,lake:i,river:a}}function Ht(e,t){let n=e.requirements?.conditions;return!n||!(!t||Array.isArray(n.weather)&&n.weather.length&&!n.weather.includes(t.type)||Array.isArray(n.season)&&n.season.length&&!n.season.includes(t.season)||Array.isArray(n.dayPhase)&&n.dayPhase.length&&!n.dayPhase.includes(t.dayPhase))}function Ut(e,t,n,r,i,a,o=null){let s=e.requirements||{};if(t<(s.minHealth||0)||n<(s.minBalance||0)||!Ht(e,o))return!1;for(let[e,t]of Object.entries(s.objects||{}))if((r[e]||0)<t)return!1;for(let e of s.animals||[])if(!i.has(e))return!1;let c=s.water;return!(c&&((a.tiles||0)<(c.tiles||0)||(a.lake||0)<(c.lake||0)||(a.river||0)<(c.river||0)))}function Wt(e,t){let n=e.requirements?.objects||{},r=Object.keys(n);if(!r.length)return 70;let i=30,a=0,o=0;for(let[e,s]of Object.entries(n)){let n=t[e]||0;n>=s?(i+=Math.round(30/r.length),o+=n-s):a++}return i+=Math.round(40*(1-Math.exp(-o/6))),i-=a*25,k(i,5,100)}function Gt(e,t){let r=e.requirements||{},i=[],a=Object.entries(r.objects||{}).map(([e,r])=>n(`server.whyReturned.objectQty`,{qty:r,name:t.object.get(e)?.name||e}));if(a.length&&i.push(n(`server.whyReturned.habitat`,{objects:a.join(n(`server.list.comma`))})),r.water){let e=r.water;e.lake?i.push(n(`server.whyReturned.lake`,{tiles:e.lake})):e.river?i.push(n(`server.whyReturned.river`,{tiles:e.river})):e.tiles&&i.push(n(`server.whyReturned.tiles`,{tiles:e.tiles}))}r.minHealth&&i.push(n(`server.whyReturned.health`,{health:r.minHealth})),r.minBalance&&i.push(n(`server.whyReturned.balance`,{balance:r.minBalance})),r.animals?.length&&i.push(n(`server.whyReturned.animals`,{animals:r.animals.map(e=>t.animal.get(e)?.name||e).join(n(`server.list.and`))}));let o=r.conditions;if(o){let e=[];o.weather?.length&&e.push(o.weather.join(n(`server.list.or`))),o.season?.length&&e.push(n(`server.whyReturned.inSeason`,{seasons:o.season.join(n(`server.list.or`))})),o.dayPhase?.length&&e.push(n(`server.whyReturned.atPhase`,{phases:o.dayPhase.join(n(`server.list.or`))})),e.length&&i.push(n(`server.whyReturned.moment`,{conditions:e.join(n(`server.list.comma`))}))}return n(`server.whyReturned.sentence`,{reasons:i.join(n(`server.list.comma`))})}async function X(e,t,i,a={}){let o=D(),s=await B();if(!s.biome.get(i))throw new O(n(`server.err.unknownBiome`,{biome:i}));let c=(await F(o.Placement,e)).filter(e=>e.area===i);a.removeIds?.length&&(c=c.filter(e=>!a.removeIds.includes(e.id)));for(let e of a.addPlacements||[])e.area===i&&(c=c.filter(t=>t.id!==e.id),c.push(e));let l=Dt(c,s),u=(await F(o.TerrainTile,e)).filter(e=>e.area===i);a.removeTerrainIds?.length&&(u=u.filter(e=>!a.removeTerrainIds.includes(e.id)));for(let e of a.addTerrain||[])e.area===i&&(u=u.filter(t=>t.id!==e.id),u.push(e));let d=Math.min(3,u.filter(e=>e.type===`watered`).length)*.5,f=u.filter(e=>e.type===`water`&&!e.seeded).length,p=Vt(u),h=kt(It(s,c,f,Date.now())+d),g=a.player||await j(o.Player,t),v=g?E(g):null,y=v===null?null:{type:_(e,i,v),season:r(v),dayPhase:m(v)},b=await F(o.Discovery,e),x=new Set(b.map(e=>e.animalId)),S=()=>[...x].filter(e=>s.animal.get(e)?.biome===i).length,C=Math.min(h,jt(S())),w=Bt(s,i,x),T=[],ee=s.animals.filter(e=>e.biome===i),te=x.has(V);for(let n of ee)if(!x.has(n.id)&&!(!te&&n.id!==V)&&Ut(n,C,w,l,x,p,y)){let r={id:`${e}:${n.id}`,worldId:e,playerId:t,animalId:n.id,biomeId:i,comfort:Wt(n,l),timesObserved:0,firstObservedAt:Date.now(),whyReturned:Gt(n,s)};await o.Discovery.put(r),x.add(n.id),w=Bt(s,i,x),T.push({...r,animal:n});break}C=Math.min(h,jt(S()));for(let e of b){if(e.biomeId!==i)continue;let t=s.animal.get(e.animalId);if(!t)continue;let n=Wt(t,l);n!==e.comfort&&await o.Discovery.patch(e.id,{comfort:n})}let ne=S(),re=await pe(o.BiomeState,e,i),ie=re?.id??`${e}:${i}`;await o.BiomeState.patch(ie,{health:C,balance:w,returnedCount:ne});let ae={...re||{id:ie,worldId:e,playerId:t,biomeId:i,unlocked:i===`meadow`},health:C,balance:w,returnedCount:ne},k=C-(re?.health??xe),oe={};if(k>0&&(oe[`health:${i}`]=k),T.length&&(oe[`animal:${i}`]=T.length,oe.animal=T.length),Object.keys(oe).length){let e=a.player||await o.Player.get(t);e&&await J(e,{},oe)}return{biomeState:ae,newAnimals:T,unlockedBiomes:await Jt(e,t,{player:a.player,freshState:ae})}}var Kt={wetland:[...[6,7,8,9,10,11,12,13,14].map(e=>({x:e,y:4,type:`water`})),{x:14,y:5,type:`water`},{x:14,y:6,type:`water`},{x:15,y:6,type:`water`},{x:20,y:6,type:`water`},{x:21,y:6,type:`water`},{x:22,y:6,type:`water`},{x:20,y:7,type:`water`},{x:21,y:7,type:`water`},{x:22,y:7,type:`water`},{x:10,y:14,type:`watered`},{x:11,y:14,type:`watered`}]};async function qt(e,t,n){let r=Kt[n];if(!r)return;let i=D();for(let a of r){let r=`${e}:${n}:${a.x}:${a.y}`;await i.TerrainTile.get(r)||await i.TerrainTile.put({id:r,worldId:e,playerId:t,area:n,x:a.x,y:a.y,type:a.type,seeded:!0,updatedAt:Date.now()})}}async function Jt(e,t,n={}){let r=D(),i=await B(),a=n.player||await r.Player.get(t),o=[],s=new Set(a.unlockedBiomes||[]),c=new Set(a.pendingUnlockRewards||[]),l=new Set((await F(r.BiomeState,e)).filter(e=>e.unlocked).map(e=>e.biomeId));for(let u of i.biomes){if(!u.unlock||l.has(u.id))continue;let i=u.unlock,d=n.freshState?.biomeId===i.biome?n.freshState:await pe(r.BiomeState,e,i.biome);if(!d||!l.has(i.biome)||(d.health||0)<(i.minHealth||0)||(d.returnedCount||0)<(i.minAnimals||0)||i.minTotalAnimals&&(await F(r.Discovery,e)).length<i.minTotalAnimals)continue;if(i.requiresItem){let e=a.craftedItems?.[i.requiresItem]||0,t=a.craftedEver?.[i.requiresItem]||0;if(e<=0&&t<=0)continue}if(i.requiresTool&&(a.tools?.[i.requiresTool.id]||1)<i.requiresTool.tier)continue;l.add(u.id),s.add(u.id),c.add(u.id),await r.Player.patch(t,{unlockedBiomes:[...s],pendingUnlockRewards:[...c]});let f=await pe(r.BiomeState,e,u.id);await r.BiomeState.patch(f?.id??`${e}:${u.id}`,{unlocked:!0}),await qt(e,t,u.id),o.push({id:u.id,name:u.name})}return o}function Yt(e,t){let n=e.unlock;return!n||!(typeof n.minHealth==`number`&&t.health<n.minHealth||typeof n.animalsReturned==`number`&&t.animalsReturned<n.animalsReturned||n.requiresAnimal&&!t.returnedAnimalIds.has(n.requiresAnimal)||n.requiresCrafted&&(t.craftedEver?.[n.requiresCrafted]||0)<=0)}async function Xt(e,t,n,r){let i=D(),a=await pe(i.BiomeState,e,t),o=await F(i.Discovery,e),s=new Set(o.filter(e=>r.animal.get(e.animalId)?.biome===t).map(e=>e.animalId));return{health:a?.health||0,animalsReturned:s.size,returnedAnimalIds:s,craftedEver:n.craftedEver||{}}}async function Zt(e,t,n,r){let i=await fe(e.Chest,r,n);if(i)return i;let a=await fe(e.Placement,r,n);if(a){let i=t.object.get(a.objectId);if(i?.isChest){let t={id:n,worldId:r,playerId:a.playerId,area:a.area,x:a.x,y:a.y,size:a.objectId,capacity:i.chestCapacity||60,contents:{}};return await e.Chest.put(t),t}}return null}async function Qt(e,t,r=e.id){let i=D(),a=await F(i.Chest,r);for(let[r,i]of Object.entries(t)){let t=e.inventory?.[r]||0,o=a.reduce((e,t)=>e+(t.contents?.[r]||0),0);if(t+o<i)throw new O(n(`server.err.notEnough`,{resource:r,need:i,have:t+o}))}let o={inventory:{},chests:{}},s={...e.inventory||{}},c=new Map(a.map(e=>[e.id,{...e.contents||{}}]));for(let[e,r]of Object.entries(t)){let t=r,i=Math.min(s[e]||0,t);i>0&&(s[e]-=i,s[e]<=0&&delete s[e],o.inventory[e]=i,t-=i);for(let n of a){if(t<=0)break;let r=c.get(n.id),i=Math.min(r[e]||0,t);i>0&&(r[e]-=i,r[e]<=0&&delete r[e],o.chests[n.id]=o.chests[n.id]||{},o.chests[n.id][e]=i,t-=i)}if(t>0)throw new O(n(`server.err.notEnoughShort`,{resource:e}))}await i.Player.patch(e.id,{inventory:s});for(let e of a)o.chests[e.id]&&await i.Chest.patch(e.id,{contents:c.get(e.id)});return{usedFrom:o,inventory:s}}var $t={craft:`hammer`,build:`hammer`,grow:`leaf`,plant:`leaf`,collect:`basket`,observe:`journal`,welcome:`paw`,attract:`paw`,welcomeTotal:`paw`,home:`home`,tool:`hammer`,unlock:`map`,health:`leaf`,biomeAnimals:`paw`},en=[`space`,`comfort`,`decor`,`light`],tn=6;function nn(e,t){let n=new Set(e?.unlockedBiomes||[`meadow`]);return t.biomes.filter(e=>e.explorable).every(e=>n.has(e.id))?6:3}function rn(e){let{d:t,biomeStates:r,discoveries:i,player:a}=e,o=new Map(r.map(e=>[e.biomeId,e]));for(let e of t.biomes){let r=e.unlock;if(!r||o.get(e.id)?.unlocked)continue;let s=o.get(r.biome);if(!s?.unlocked||!(a?.visitedBiomes||[`meadow`]).includes(r.biome))continue;let c=t.biome.get(r.biome)?.name||r.biome,l=t.biome.get(e.id)?.name||e.id,u=[];if(r.minHealth&&u.push({text:n(`server.nextbiome.health`,{biome:c,goal:r.minHealth,cur:Math.round(s.health||0)}),done:(s.health||0)>=r.minHealth}),r.minAnimals&&u.push({text:n(`server.nextbiome.animals`,{biome:c,goal:r.minAnimals,cur:s.returnedCount||0}),done:(s.returnedCount||0)>=r.minAnimals}),r.minTotalAnimals&&u.push({text:n(`server.nextbiome.total`,{goal:r.minTotalAnimals,cur:i.length}),done:i.length>=r.minTotalAnimals}),r.requiresItem){let e=t.object.get(r.requiresItem)?.name||r.requiresItem,i=(a?.craftedItems?.[r.requiresItem]||0)+(a?.craftedEver?.[r.requiresItem]||0);u.push({text:n(`server.nextbiome.craft`,{item:e}),done:i>0})}if(!u.length)return null;let d=u.filter(e=>e.done).length;return{id:`next-biome`,kind:`unlock`,icon:`map`,pinned:!0,text:n(`server.nextbiome.title`,{biome:l}),hint:n(`server.nextbiome.hint`,{biome:l}),target:u.length,progress:d,counter:``,reward:{},steps:u,claimed:!1}}return null}function an(e,t){let r=t.d.animal.get(e);if(!r)return[];let i=(t.d.biome.get(r.biome)?.order||1)+1;if((t.player?.tools?.[`field-journal`]||1)<i)return[{text:n(`server.goal.upgradeGuide`),done:!1}];let a=[];for(let[e,i]of Object.entries(r.requirements?.objects||{})){let o=(t.placements||[]).filter(t=>t.objectId===e&&t.area===r.biome).length;a.push({text:n(`server.goal.habitatStep`,{have:Math.min(o,i),need:i,name:t.d.object.get(e)?.name||e}),done:o>=i})}if(r.requirements?.minHealth){let e=t.biomeStates.find(e=>e.biomeId===r.biome),i=Math.round(e?.health||0);a.push({text:n(`server.goal.healthStep`,{cur:i,need:r.requirements.minHealth}),done:i>=r.requirements.minHealth})}return a}function on(e,t){return ln((t.d.recipes||[]).find(t=>t.output?.itemId===e)?.materials||{},t)}function sn(e,t){return ln(H[e]?.materials||{},t)}function cn(e,t,n){return ln((n.d.tool.get(e)?.tiers||[]).find(e=>e.tier===t)?.materials||{},n)}function ln(e,t){return Object.entries(e).map(([e,r])=>{let i=pn(t,e);return{text:n(`server.goal.matStep`,{have:Math.min(i,r),need:r,name:t.d.resource.get(e)?.name||e}),done:i>=r}})}function un(e){let n=(e.unlockedBiomes?.length?e.unlockedBiomes:e.player?.unlockedBiomes?.length?e.player.unlockedBiomes:[`meadow`]).flatMap(t=>e.d.biome.get(t)?.resources||[]);return[...new Set(n)].filter(n=>n!==`water`&&!t(n)&&e.d.resource.get(n))}function dn(e,t){let n=un(e),r={};if(!n.length)return r;let i=se(oe(`goalreward:${t}`)),a=[...n];for(let e=0;e<2&&a.length;e++){let e=a.splice(Math.floor(i()*a.length),1)[0];r[e]=3+Math.floor(i()*3)}return r}function fn(e,n){let r=(e.d.biome.get(n)?.resources||[]).filter(n=>n!==`water`&&!t(n)&&e.d.resource.get(n)),i={};if(!r.length)return i;let a=se(oe(`unlockreward:${n}`)),o=[...r];for(let e=0;e<2&&o.length;e++){let e=o.splice(Math.floor(a()*o.length),1)[0];i[e]=4+Math.floor(a()*3)}return i}function pn(e,t){return(e.player?.inventory?.[t]||0)+(e.chests||[]).reduce((e,n)=>e+(n.contents?.[t]||0),0)}function mn(e,t){return(e.placements||[]).filter(e=>e.objectId===t).length}function hn(e,t){return(e.placements||[]).filter(e=>e.objectId===t&&typeof e.plantedAt==`number`).length}function gn(e,t){switch(e.kind){case`craft`:case`build`:return t.player?.craftedEver?.[e.itemId||``]||0;case`grow`:return hn(t,e.itemId||``);case`plant`:return(t.placements||[]).filter(e=>typeof e.plantedAt==`number`).length;case`collect`:return pn(t,e.resourceId||``);case`observe`:return t.discoveries.filter(e=>(e.timesObserved||0)>0).length;case`welcomeTotal`:return t.discoveries.length;default:return 0}}function _n(e,t){switch(e.kind){case`craft`:case`grow`:case`plant`:case`collect`:case`observe`:case`welcomeTotal`:return Math.max(0,Math.min(e.target,gn(e,t)-(e.base||0)));case`build`:return Math.max(0,Math.min(e.target,(t.player?.craftedEver?.[e.itemId||``]||0)-(e.base||0)))+Math.max(0,Math.min(e.target,mn(t,e.itemId||``)-(e.basePlace||0)));case`welcome`:case`attract`:return+!!t.discoveries.some(t=>t.animalId===e.animalId);case`home`:if(e.track===`build`){let n=t.player?.home;return n?.styleLocked?+(!e.styleId||n.style===e.styleId):0}return t.player?.home?.[e.track||``]>=e.target?e.target:Math.min(e.target,t.player?.home?.[e.track||``]||1);case`tool`:{let n=t.player?.tools?.[e.toolId||``]||1;return Math.min(e.target,n)}case`unlock`:return+!!t.biomeStates.some(t=>t.biomeId===e.biomeId&&t.unlocked);case`health`:{let n=t.biomeStates.find(t=>t.biomeId===e.biomeId);return Math.min(e.target,Math.round(n?.health||0))}case`biomeAnimals`:{let n=t.discoveries.filter(t=>t.biomeId===e.biomeId).length;return Math.min(e.target,n)}default:return 0}}function vn(e,t){let r=t.d;switch(e.kind){case`craft`:return n(`server.goal.craft`,{count:e.target,item:r.object.get(e.itemId)?.name||e.itemId});case`build`:return n(`server.goal.build`,{count:e.target,item:r.object.get(e.itemId)?.name||e.itemId});case`grow`:return n(`server.goal.grow`,{count:e.target,item:r.object.get(e.itemId)?.name||e.itemId});case`plant`:return n(`server.goal.plant`,{count:e.target});case`collect`:return n(`server.goal.collect`,{count:e.target,resource:r.resource.get(e.resourceId)?.name||e.resourceId});case`observe`:return n(`server.goal.observe`,{count:e.target});case`welcome`:return n(`server.goal.welcome`,{animal:r.animal.get(e.animalId)?.name||e.animalId});case`attract`:return n(`server.goal.attract`,{kind:r.animal.get(e.animalId)?.kind||n(`server.goal.creature`)});case`welcomeTotal`:return n(`server.goal.welcomeTotal`,{count:e.target});case`home`:return e.track===`build`?n(`server.goal.buildHome`,{style:H[e.styleId||``]?.name||n(`server.goal.aHouse`)}):n(`server.goal.home`,{track:n(`server.goal.track.${e.track}`),level:e.target});case`tool`:{let t=r.tool.get(e.toolId),i=(t?.tiers||[]).find(t=>t.tier===e.target);return n(`server.goal.tool`,{tool:i?.name||t?.name||e.toolId})}case`unlock`:return n(`server.goal.unlock`,{biome:r.biome.get(e.biomeId)?.name||e.biomeId});case`health`:return n(`server.goal.restore`,{biome:r.biome.get(e.biomeId)?.name||e.biomeId,pct:e.target});case`biomeAnimals`:return n(`server.goal.biomeAnimals`,{count:e.target,biome:r.biome.get(e.biomeId)?.name||e.biomeId});default:return``}}function yn(e){let t=e.discoveries.some(e=>e.animalId===V),r=Object.keys(e.player?.craftedEver||{}).length>0;return[{id:`start-gather`,kind:`gather`,icon:`basket`,text:n(`server.task.collectSeeds`),hint:n(`server.task.gatherHint`),target:12,progress:Math.min(12,pn(e,`seeds`))},{id:`start-craft`,kind:`craft`,icon:`hammer`,text:n(`server.task.craftFirst`),hint:n(`server.task.craftFirstHint`),target:1,progress:+!!r},{id:`start-welcome`,kind:`welcome`,icon:`sparkle`,text:n(`server.task.welcomeGrasshopper`),hint:n(`server.task.welcomeGrasshopperHint`),target:1,progress:+!!t}]}function bn(e,t){let n=[],r=[`craft`,`build`,`grow`,`plant`,`collect`,`observe`,`welcome`,`attract`,`welcomeTotal`,`home`,`tool`,`unlock`,`health`,`biomeAnimals`],i=!1;for(let a of Array.isArray(e)?e:[]){if(n.length>=tn)break;let e=a?.kind;if(!r.includes(e))continue;if(e===`home`){if(i)continue;i=!0}let o={id:typeof a?.id==`string`&&a.id?a.id.slice(0,40):`cg_${Math.random().toString(36).slice(2,10)}`,kind:e,target:Math.max(1,Math.min(99,Math.floor(Number(a?.target)||1)))};if(e===`craft`||e===`build`||e===`grow`){if(!t.object.get(a?.itemId))continue;o.itemId=a.itemId}else if(e===`collect`){if(!t.resource.get(a?.resourceId))continue;o.resourceId=a.resourceId}else if(e===`welcome`||e===`attract`){if(!t.animal.get(a?.animalId))continue;o.animalId=a.animalId,o.target=1}else if(e===`home`)if(a?.track===`build`){if(!H[a?.styleId])continue;o.track=`build`,o.styleId=a.styleId,o.target=1}else{if(!en.includes(a?.track))continue;o.track=a.track}else if(e===`tool`){let e=t.tool.get(a?.toolId);if(!e)continue;let n=Math.max(1,...(e.tiers||[]).map(e=>e.tier));o.toolId=a.toolId,o.target=Math.min(n,Math.max(2,Math.floor(Number(a?.target)||2)))}else if(e===`unlock`){if(!t.biome.get(a?.biomeId))continue;o.biomeId=a.biomeId,o.target=1}else if(e===`health`){if(!t.biome.get(a?.biomeId))continue;o.biomeId=a.biomeId,o.target=Math.max(1,Math.min(100,Math.floor(Number(a?.target)||100)))}else if(e===`biomeAnimals`){if(!t.biome.get(a?.biomeId))continue;let e=t.animals.filter(e=>e.biome===a.biomeId).length;if(e<=0)continue;o.biomeId=a.biomeId,o.target=e}n.push(o)}return n}function xn(e){let{player:t,now:r,d:i}=e,a=ut(t,r),o=t?.goalClaims||{},s=[],c=t?.pendingUnlockRewards||[];if(!c.length){let t=rn(e);t&&s.push(t)}for(let t of c){let r=i.biome.get(t)?.name||t;s.push({id:`unlock-reward:${t}`,kind:`unlock`,icon:`sparkle`,text:n(`server.unlockreward.title`,{biome:r}),hint:n(`server.unlockreward.hint`,{biome:r}),target:1,progress:1,counter:``,reward:fn(e,t),claimed:!1})}for(let t of yn(e))o[t.id]||s.push({...t,counter:``,reward:dn(e,t.id),claimed:!1});for(let r of t?.customGoals||[]){if(o[r.id])continue;let t=r.kind===`build`?r.target*2:r.target,i=r.kind===`attract`?an(r.animalId||``,e):r.kind===`craft`||r.kind===`build`?on(r.itemId||``,e):r.kind===`home`&&r.track===`build`?sn(r.styleId||``,e):r.kind===`tool`?cn(r.toolId||``,r.target,e):void 0;s.push({id:r.id,kind:r.kind,icon:$t[r.kind]||`check`,text:vn(r,e),target:t,counter:``,reward:dn(e,r.id),progress:_n(r,e),claimed:!1,hint:n(`server.goal.hint.${r.kind}`),...i?{steps:i}:{}})}return{dayKey:a,endsAt:0,tasks:s}}async function Sn(e,t={}){let n=D(),r=await B(),i=await j(n.Player,e),a=r.biome.get(i?.area),o=Ae(i?.area),s=o?!!r.biome.get(o)?.explorable:!1;i&&i.area!==`home`&&!s&&(!a||!a.explorable)&&(i={...i,area:`meadow`,x:24.5,y:6.5});let c=t.worldId||P(i),[u,d,f,p,m,h,g,_]=await Promise.all([F(n.BiomeState,c),F(n.Placement,c),F(n.Chest,c),F(n.Discovery,c),F(n.NodeState,c),F(n.TerrainTile,c),N(n.PlayerAchievement,e),F(n.FeedEntry,c)]),v=[...i?.unlockedBiomes?.length?i.unlockedBiomes:[`meadow`]];if(i&&c!==i.id){let e=new Set(i.unlockedBiomes||[`meadow`]);for(let t of u)t.unlocked&&e.add(t.biomeId);i={...i,unlockedBiomes:[...e]}}let y=Date.now(),b=E(i);return{player:Ke(i),worldId:c,biomeStates:u,placements:d,chests:f,discoveries:p,nodeStates:m,terrain:h,achievements:[...g].sort((e,t)=>(t.earnedAt||0)-(e.earnedAt||0)).map(e=>e.achievementId),feed:[..._].sort((e,t)=>(e.at||0)-(t.at||0)).slice(-100).map(e=>({id:e.id,at:e.at,icon:e.icon,text:e.text})),serverTime:y,weather:l(c,b,ae,i?.devWeather||null),dailyTasks:xn({wid:c,player:i,d:r,discoveries:p,biomeStates:u,placements:d,chests:f,now:y,unlockedBiomes:v}),customGoals:i?.customGoals||[],goalLimit:nn(i,r),nodeRegenSeconds:be,inventoryCapacity:Et(i)}}async function Z(e){let t=await e;if(!t||typeof t!=`object`)throw new O(n(`server.err.bodyRequired`));return t}var Cn={"welcome-grasshopper":e=>!!e.disc(`grasshopper`),forager:e=>(e.counts.resourcesCollected||0)>=100,"makers-hands":e=>(e.counts.itemsCrafted||0)>=10,"green-thumb":e=>(e.counts.plantsPlanted||0)>=10,waterworks:e=>(e.counts.terraformActions||0)>=15,"meadow-first-bloom":e=>e.returned(`meadow`)>=8,"meadow-pollinators":e=>e.kindReturned(`meadow`,`insect`)>=5,"meadow-apex":e=>!!e.disc(`red-fox-meadow`),"meadow-mender":e=>e.health(`meadow`)>=80,"meadow-reborn":e=>e.returned(`meadow`)>=25,"forest-understory":e=>e.returned(`forest`)>=10,"forest-cavities":e=>!!e.disc(`pileated-woodpecker`)&&(!!e.disc(`wood-duck`)||!!e.disc(`northern-flying-squirrel`)||!!e.disc(`great-horned-owl`)||!!e.disc(`barred-owl`)),"forest-night-shift":e=>!!e.disc(`great-horned-owl`)&&!!e.disc(`barred-owl`)&&!!e.disc(`little-brown-bat`),"forest-canopy":e=>e.health(`forest`)>=80,"forest-reborn":e=>e.returned(`forest`)>=25,"wetland-first-water":e=>e.returned(`wetland`)>=8,"wetland-engineer":e=>!!e.disc(`beaver`),"wetland-lakemaker":e=>e.water(`wetland`).lake>=6,"wetland-restored":e=>e.health(`wetland`)>=80,"wetland-reborn":e=>e.returned(`wetland`)>=25,"desert-first-life":e=>e.returned(`desert`)>=8,"desert-burrows":e=>!!e.disc(`burrowing-owl`)&&!!e.disc(`kangaroo-rat`)&&!!e.disc(`desert-tortoise`),"desert-hunter":e=>!!e.disc(`rattlesnake`)||!!e.disc(`coyote`),"desert-restored":e=>e.health(`desert`)>=80,"desert-reborn":e=>e.returned(`desert`)>=25,"alpine-treeline":e=>e.returned(`alpine`)>=8,"alpine-haypile":e=>!!e.disc(`pika`),"alpine-crown":e=>!!e.disc(`golden-eagle`),"alpine-restored":e=>e.health(`alpine`)>=80,"alpine-reborn":e=>e.returned(`alpine`)>=25,"coastal-tide":e=>e.returned(`coastal`)>=8,"coastal-keystone":e=>!!e.disc(`sea-star`),"coastal-otter":e=>!!e.disc(`sea-otter`),"coastal-restored":e=>e.health(`coastal`)>=80,"coastal-reborn":e=>e.returned(`coastal`)>=25,"well-stocked":e=>(e.counts.resourcesCollected||0)>=1e3,"master-builder":e=>(e.counts.objectsPlaced||0)>=150,"master-gardener":e=>(e.counts.plantsPlanted||0)>=75,landscaper:e=>(e.counts.terraformActions||0)>=150,"fully-equipped":e=>e.tool(`basket`)>=4&&e.tool(`shovel`)>=4&&e.tool(`watering-can`)>=4,naturalist:e=>e.tool(`field-journal`)>=7,"recipe-collector":e=>e.craftedDistinct>=75,"open-road":e=>e.unlockedCount>=2,"welcoming-committee":e=>e.totalReturned>=50,"full-house":e=>e.totalReturned>=100,"field-notes":e=>(e.counts.animalsObserved||0)>=100,"steady-hand":e=>e.unlockedCount>=3&&e.unlockedHealthy(50),"three-restored":e=>e.biomesAtHealth(80)>=3,trailblazer:e=>e.unlockedCount>=6,"caretaker-of-the-whole":e=>e.totalReturned>=150};async function wn(e){let t=await N(D().PlayerAchievement,e);return new Set(t.map(e=>e.achievementId))}async function Tn(e){let t=await B(),n=await N(D().PlayerAchievement,e),r=t.achievements.length||1,i=new Map(n.map(e=>[e.achievementId,e])),a=t.achievements.reduce((e,t)=>e+(i.has(t.id)&&t.points||0),0),o={};for(let e of t.achievements)i.has(e.id)&&(o[e.category]=(o[e.category]||0)+1);let s=[...n].sort((e,t)=>(t.earnedAt||0)-(e.earnedAt||0)).slice(0,5).map(e=>({id:e.achievementId,name:t.achievement.get(e.achievementId)?.name||e.achievementId,earnedAt:e.earnedAt}));return{earned:n.length,total:t.achievements.length,points:a,completion:Y(n.length/r),byCategory:o,recent:s}}async function Q(e,t={}){try{let n=D(),r=await B(),i=await n.Player.get(e);if(!i)return[];let a=await wn(e),o=P(i),[s,c,l]=await Promise.all([F(n.BiomeState,o),F(n.Discovery,o),F(n.TerrainTile,o)]);for(let e of t.addDiscoveries||[])e?.animalId&&!c.some(t=>t.animalId===e.animalId)&&c.push(e);for(let e of t.freshBiomeStates||[])e?.biomeId&&(s=s.filter(t=>t.biomeId!==e.biomeId),s.push(e));let u=new Map(s.map(e=>[e.biomeId,e])),d=new Map(c.map(e=>[e.animalId,e])),f=new Map,p=new Set(i.unlockedBiomes||[]),m={counts:q(i)?.counts||{},health:e=>u.get(e)?.health||0,returned:e=>u.get(e)?.returnedCount||0,disc:e=>d.get(e),totalReturned:c.length,kindReturned:(e,t)=>c.filter(n=>{let i=r.animal.get(n.animalId);return i&&i.biome===e&&i.kind===t}).length,tool:e=>i.tools?.[e]||1,unlockedCount:(i.unlockedBiomes||[]).length,craftedDistinct:Object.keys(i.craftedEver||{}).length,tutorialStep:i.tutorialStep||0,water:e=>(f.has(e)||f.set(e,Vt(l.filter(t=>t.area===e),!0)),f.get(e)),biomesAtHealth:e=>s.filter(t=>(t.health||0)>=e).length,unlockedHealthy:e=>s.filter(e=>p.has(e.biomeId)).every(t=>(t.health||0)>=e)},h=Date.now(),g=[];for(let t of r.achievements){if(a.has(t.id))continue;let r=Cn[t.id];!r||!r(m)||(await n.PlayerAchievement.put({id:`${e}:${t.id}`,playerId:e,achievementId:t.id,biome:t.biome,earnedAt:h}),g.push(t))}return g}catch{return[]}}async function En(e,t,n={}){let r=await Q(t,n);try{let r=D(),i=await r.World.get(e);if(i&&!i.solo)for(let i of await F(r.WorldMember,e))i.playerId!==t&&await Q(i.playerId,n)}catch{}return r}var $=class extends Resource{allowRead(){return!0}allowCreate(){return!0}allowUpdate(){return!0}allowDelete(){return!1}},Dn=class extends ${async get(){return{build:T}}},On=class extends ${async get(){let e=await B();return{biomes:e.biomes,animals:e.animals,resources:e.resources,recipes:e.recipes,habitatObjects:e.objects.map(e=>({...e,rotatable:nr(e)})),tools:e.tools,achievements:e.achievements,homeStyles:H,homeTracks:U,nodeRegenSeconds:be,appearanceOptions:{skins:Ie,hair:Le,outfits:Re,hats:ze,hatColors:Be,hairstyles:Ve,beards:He,bodies:Ue}}}},kn=class extends ${async post(e){let{name:t,passcode:r,appearance:i,tzOffsetMinutes:a,creationMs:o,edition:s}=await Z(e),c=s===`demo`?`demo`:`full`,l=String(t||``).trim();if(l.length<2||l.length>24)throw new O(n(`server.err.nameLength`));let u=String(r||``);if(u.length<4||u.length>32)throw new O(n(`server.err.passcodeLength`));let d;if(c===`demo`){let e=Xe(l)||`caretaker`,t=D();do d=`${e}-${Math.random().toString(36).slice(2,8)}`;while(await j(t.Player,d))}else{if(d=Xe(l),!d)throw new O(n(`server.err.nameNeedsAlnum`));if(await j(D().Player,d))throw new O(n(`server.err.saveExists`),409)}let f=k(Math.round(Number(o)||0),0,36e5),p=await wt(d,l,u,Ge(i),lt(a),f,c),m=[];try{await R(p.player,{freshGrid:!0}),m=await ge(d)}catch(e){console.error(`world setup skipped (CreatePlayer):`,e)}return{ok:!0,playerId:d,worldId:d,worlds:m,state:await Tt(p)}}},An=class extends ${async post(e){let{name:t,passcode:r}=await Z(e),i=Xe(String(t||``)),a=i?await D().Player.get(i):null;if(!a)throw new O(n(`server.err.noSaveWithName`),404);if(!await Ye(a,r))throw new O(n(`server.err.passcodeMismatch`),403);let o=D(),s=0;for(let e of[o.Placement,o.Chest,o.BiomeState,o.Discovery,o.NodeState,o.TerrainTile,o.FeedEntry])for(let t of await F(e,i))await e.delete(t.id),s++;for(let e of await N(o.PlayerAchievement,i))await o.PlayerAchievement.delete(e.id),s++;for(let e of await N(o.WorldMember,i))await o.WorldMember.delete(e.id),s++;return await o.World.get(i)&&(await o.World.delete(i),s++),await o.Player.delete(i),{ok:!0,deleted:i,recordsRemoved:s+1}}},jn=class extends ${async post(e){let{playerId:t}=await Z(e),r=Xe(String(t||``)),i=D(),a=r?await j(i.Player,r):null;if(!a)return{ok:!0,deleted:null};if(q(a)?.edition!==`demo`)throw new O(n(`server.err.notDemoSave`),403);let o=0;for(let e of[i.Placement,i.Chest,i.BiomeState,i.Discovery,i.NodeState,i.TerrainTile,i.FeedEntry])for(let t of await F(e,r))await e.delete(t.id),o++;for(let e of await N(i.PlayerAchievement,r))await i.PlayerAchievement.delete(e.id),o++;for(let e of await N(i.WorldMember,r))await i.WorldMember.delete(e.id),o++;return await j(i.World,r)&&(await i.World.delete(r),o++),await i.Player.delete(r),{ok:!0,deleted:r,recordsRemoved:o+1}}},Mn=class extends ${async post(e){let{playerId:t}=await Z(e),r=Xe(String(t||``)),i=D(),a=r?await j(i.Player,r):null;if(!a)throw new O(n(`server.err.noSaveWithName`),404);if(q(a)?.edition!==`demo`)throw new O(n(`server.err.notDemoSave`),403);let o=P(a),s={...a,metrics:tt({...q(a)||{},edition:`full`})};return{ok:!0,meta:{playerId:r,name:a.name||`Caretaker`,appearance:a.appearance||{},createdAt:a.createdAt||Date.now(),updatedAt:Date.now()},data:{Player:[s],PlayerAchievement:await N(i.PlayerAchievement,r),BiomeState:await F(i.BiomeState,o),Chest:await F(i.Chest,o),Placement:await F(i.Placement,o),Discovery:await F(i.Discovery,o),NodeState:await F(i.NodeState,o),TerrainTile:await F(i.TerrainTile,o),FeedEntry:await F(i.FeedEntry,o),World:await j(i.World,o)?[await j(i.World,o)]:[],WorldMember:await N(i.WorldMember,r),WorldPresence:[],JoinRequest:[]}}}},Nn=class extends ${async post(e){let{playerId:t,currentPasscode:r,newPasscode:i}=await Z(e),{player:a}=await K(t);if(!await Ye(a,r))throw new O(n(`server.err.passcodeMismatch`),403);let o=String(i||``);if(o.length<4||o.length>32)throw new O(n(`server.err.newPasscodeLength`));let{salt:s,hash:c}=qe(o);return await D().Player.patch(t,{passcodeHash:c,passcodeSalt:s,passcode:null}),{ok:!0}}},Pn=class extends ${async post(e){let{name:t,passcode:r,tzOffsetMinutes:i}=await Z(e),a=Xe(String(t||``)),o=a?await j(D().Player,a):null;if(!o)throw new O(n(`server.err.noSaveTryNew`),404);if(!await Ye(o,r))throw new O(n(`server.err.passcodeMismatch`),403);let s=await B(),c=Date.now(),l=q(o)||et(o.createdAt||c);await D().Player.patch(a,{metrics:tt({...l,lastHeartbeatAt:0}),...i==null?{}:{tzOffsetMinutes:lt(i)}});let u=o.worldId||a,d=[];try{await R(o),u=(await D().Player.get(a)).worldId||a,await _e(a,u),d=await ge(a)}catch(e){console.error(`world setup skipped (LoginPlayer):`,e)}let f=s.biome.get(o.area);return(o.area===`home`||!f||!f.explorable)&&await D().Player.patch(a,{area:`meadow`,x:24.5,y:6.5}),{ok:!0,playerId:a,worldId:u,worlds:d,state:await Sn(a)}}},Fn=class extends ${async get(){let e=String(this.getId()||``);return await K(e),Sn(e)}},In=class extends ${async post(e){let{playerId:t}=await Z(e),{player:n}=await K(t);return await R(n),{ok:!0,activeWorldId:P(n),worlds:await ge(t)}}},Ln=class extends ${async post(e){let{playerId:t,name:r}=await Z(e),i=D(),{player:a}=await K(t);await R(a);let o=String(r||``).trim()||n(`server.world.coopName`,{name:a.name});if(o.length>40)throw new O(n(`server.err.worldNameLength`));let s=`w_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,c=he(),l=await M(i.World),u=new Set(l.map(e=>e.joinCode).filter(Boolean)),d=0;for(;u.has(c)&&d++<20;)c=he();let f=Date.now();await i.World.put({id:s,name:o,solo:!1,ownerId:t,joinCode:c,createdAt:f,maxMembers:L}),await i.WorldMember.put({id:`${s}:${t}`,worldId:s,playerId:t,role:`owner`,joinedAt:f,lastSeenAt:f});let p=await B();for(let e of p.biomes)await i.BiomeState.put({id:`${s}:${e.id}`,worldId:s,playerId:t,biomeId:e.id,health:xe,balance:0,returnedCount:0,unlocked:e.id===`meadow`});return{ok:!0,world:{worldId:s,name:o,joinCode:c,solo:!1,role:`owner`,isOwner:!0,memberCount:1,maxMembers:L},worlds:await ge(t)}}};async function Rn(e,t){let n=String(t||``).trim().toUpperCase();return n&&(await M(e.World)).find(e=>!e.solo&&e.joinCode===n)||null}var zn=class extends ${async post(e){let{playerId:t,joinCode:r,token:i}=await Z(e),a=D(),{player:o}=await K(t);await R(o);let s=await Rn(a,r);if(!s)throw new O(n(`server.err.noWorldWithCode`),404);let c=`${s.id}:${t}`;if(!await a.WorldMember.get(c)){let e=String(i||``).trim(),r=e?await a.JoinRequest.get(`${s.id}:${e}`):null;if(!r||r.status!==`approved`)throw new O(n(`server.err.hostNotApproved`),403);let l=s.maxMembers||L;if((await F(a.WorldMember,s.id)).length>=l)throw new O(n(`server.err.worldFullJoined`,{max:l}),409);await a.WorldMember.put({id:c,worldId:s.id,playerId:t,role:`member`,joinedAt:Date.now(),lastSeenAt:Date.now()}),await a.JoinRequest.delete(`${s.id}:${e}`);let u=Date.now();await a.FeedEntry.put({id:`f_${s.id}_${u}_${Math.random().toString(36).slice(2,7)}`,worldId:s.id,playerId:t,at:u,icon:`user`,text:n(`server.feed.joinedWorld`,{name:o.name})})}await a.Player.patch(t,{worldId:s.id}),await _e(t,s.id);let l=await ge(t);if(!l.some(e=>e.worldId===s.id)){let e=await F(a.WorldMember,s.id),n=e.some(e=>e.playerId===t)?e.length:e.length+1;l=[...l,{worldId:s.id,name:s.name,solo:!1,role:s.ownerId===t?`owner`:`member`,joinCode:s.joinCode,memberCount:n,maxMembers:s.maxMembers||L,isOwner:s.ownerId===t}]}return{ok:!0,worldId:s.id,worlds:l,state:await Sn(t,{worldId:s.id})}}},Bn=class extends ${async post(e){let{joinCode:t}=await Z(e),r=D(),i=await Rn(r,t);if(!i)return{ok:!0,exists:!1};let a=(await F(r.WorldMember,i.id)).length,o=await r.Player.get(i.ownerId),s=i.maxMembers||L;return{ok:!0,exists:!0,world:{worldId:i.id,name:i.name,hostName:o?.name||n(`server.fallback.host`),memberCount:a,maxMembers:s,full:a>=s}}}},Vn=class extends ${async post(e){let{joinCode:t,token:r,name:i}=await Z(e),a=D(),o=await Rn(a,t);if(!o)throw new O(n(`server.err.noWorldWithCode`),404);let s=String(r||``).trim();if(!s)throw new O(n(`server.err.missingToken`));let c=o.maxMembers||L;if((await F(a.WorldMember,o.id)).length>=c)throw new O(n(`server.err.worldFullClosed`,{max:c}),409);let l=String(i||``).trim().slice(0,24)||n(`server.fallback.newCaretaker`);await a.JoinRequest.put({id:`${o.id}:${s}`,worldId:o.id,token:s,name:l,status:`pending`,createdAt:Date.now()});let u=await a.Player.get(o.ownerId);return{ok:!0,worldId:o.id,world:{name:o.name,hostName:u?.name||n(`server.fallback.host`)}}}},Hn=class extends ${async post(e){let{worldId:t,token:n}=await Z(e);return{ok:!0,status:(await D().JoinRequest.get(`${t}:${String(n||``).trim()}`))?.status||`none`}}},Un=class extends ${async post(e){let{playerId:t}=await Z(e),{player:n}=await K(t),r=D(),i=P(n),a=await r.World.get(i);if(!a||a.solo||a.ownerId!==t)return{ok:!0,requests:[]};let o=(await F(r.JoinRequest,i)).filter(e=>e.status===`pending`);return o.sort((e,t)=>(e.createdAt||0)-(t.createdAt||0)),{ok:!0,requests:o.map(e=>({token:e.token,name:e.name,createdAt:e.createdAt}))}}},Wn=class extends ${async post(e){let{playerId:t,worldId:r,token:i,approve:a}=await Z(e);await K(t);let o=D(),s=await o.World.get(r);if(!s||s.solo)throw new O(n(`server.err.noCoopWorld`),404);if(s.ownerId!==t)throw new O(n(`server.err.onlyHostApproves`),403);let c=`${r}:${String(i||``).trim()}`;if(!await o.JoinRequest.get(c))throw new O(n(`server.err.requestNotPending`),404);return await o.JoinRequest.patch(c,{status:a?`approved`:`denied`,resolvedAt:Date.now()}),{ok:!0}}},Gn=class extends ${async post(e){let{playerId:t}=await Z(e),{player:r}=await K(t),i=D(),a=P(r),o=await i.World.get(a),s=o?.maxMembers||L;if(!o||o.solo)return{ok:!0,roster:[],closed:!1,maxMembers:s,joinCode:null};let c=await F(i.WorldMember,a),l=[];for(let e of c){let t=await j(i.Player,e.playerId);l.push({playerId:e.playerId,name:t?.name||n(`server.fallback.caretaker`),isOwner:e.role===`owner`||o.ownerId===e.playerId,joinedAt:e.joinedAt||0})}return l.sort((e,t)=>(e.joinedAt||0)-(t.joinedAt||0)),{ok:!0,roster:l,closed:l.length>=s,maxMembers:s,joinCode:o.joinCode}}},Kn=class extends ${async post(e){let{playerId:t,worldId:r}=await Z(e),i=D(),{player:a}=await K(t);await R(a);let o=String(r||``);if(!await i.WorldMember.get(`${o}:${t}`))throw new O(n(`server.err.notWorldMember`),403);return await i.Player.patch(t,{worldId:o}),await i.WorldMember.patch(`${o}:${t}`,{lastSeenAt:Date.now()}),await _e(t,o),{ok:!0,worldId:o,worlds:await ge(t),state:await Sn(t,{worldId:o})}}},qn=class extends ${async post(e){let{playerId:t,worldId:r}=await Z(e),i=D(),{player:a}=await K(t),o=String(r||``);if(o===t)throw new O(n(`server.err.cannotLeaveSolo`));let s=`${o}:${t}`;if(!await i.WorldMember.get(s))throw new O(n(`server.err.notInWorld`),404);await i.WorldMember.delete(s),a.worldId===o&&(await i.Player.patch(t,{worldId:t,area:`meadow`,x:24.5,y:6.5}),await _e(t,t));let c=a.worldId===o?t:a.worldId||t;return{ok:!0,worldId:c,worlds:await ge(t),state:await Sn(t,{worldId:c})}}},Jn=15e3,Yn=class extends ${async post(e){let{playerId:t,x:n,y:r,area:i}=await Z(e),a=D(),{player:o}=await K(t),s=P(o),c=Date.now(),l=Number.isFinite(Number(n))?Number(n):o.x,u=Number.isFinite(Number(r))?Number(r):o.y,d=typeof i==`string`?i:o.area;if((await a.World.get(s))?.solo)return{ok:!0,worldId:s,peers:[]};let f={...(await a.WorldPresence.get(s)||{id:s,players:{}}).players||{}};f[t]={playerId:t,name:o.name,appearance:o.appearance,area:d,x:l,y:u,t:c};for(let e of Object.keys(f))c-(f[e]?.t||0)>Jn&&delete f[e];return await a.WorldPresence.put({id:s,players:f,updatedAt:c}),{ok:!0,worldId:s,peers:Object.values(f).filter(e=>e.playerId!==t)}}},Xn=class extends ${async post(e){let{playerId:r,biomeId:i,nodeId:a,resourceId:o}=await Z(e),s=D(),l=await B(),{player:u}=await K(r),d=P(u),f=l.biome.get(i);if(!f)throw new O(n(`server.err.unknownBiome`,{biome:i}));if(!(u.unlockedBiomes||[]).includes(i))throw new O(n(`server.err.biomeLocked`,{biome:f.name}),403);let p=l.resource.get(o);if(!p)throw new O(n(`server.err.unknownResource`,{resource:o}));if(t(o)){let e=_(d,i,E(u));if(c(i,e)!==o)throw new O(n(`server.err.weatherOnly`,{resource:p.name}),409)}else if(!(f.resources||[]).includes(o))throw new O(n(`server.err.resourceNotInBiome`,{resource:o,biome:f.name}));if(!a||typeof a!=`string`)throw new O(n(`server.err.nodeIdRequired`));let m=`${d}:${i}:${a}`,h=await s.NodeState.get(m),g=Date.now();if(h&&g-h.harvestedAt<be*1e3)throw new O(n(`server.err.regrowing`),409);let v=Et(u),y=A(u.inventory);if(y>=v)throw new O(n(`server.err.basketFullStore`),409);let b=u.tools?.[p.tool]||1,x=Math.min(Math.max(1,b),v-y),S=De(u),C=+(S?.id===`forage`&&v-y-x>0&&Math.random()<S.strength),w=x+C,T={...u.inventory||{}};return T[o]=(T[o]||0)+w,await s.Player.patch(r,{inventory:T}),await s.NodeState.put({id:m,worldId:d,playerId:r,harvestedAt:g}),await J(u,{resourcesCollected:w},{[`res:${o}`]:w}),await Q(r),{ok:!0,gained:{[o]:w},perkBonus:C||void 0,inventory:T,nodeId:a,harvestedAt:g}}},Zn=class extends ${async post(e){let{playerId:t,chestId:r,resourceId:i,qty:a,direction:o}=await Z(e),s=D(),c=await B(),{player:l}=await K(t),u=P(l),d=ce(a,`qty`),f=await Zt(s,c,r,u);if(!f)throw new O(n(`server.err.chestNotFound`),404);let p={...l.inventory||{}},m={...f.contents||{}};if(o===`deposit`){if((p[i]||0)<d)throw new O(n(`server.err.notEnoughInBasket`,{resource:i}));if(A(m)+d>f.capacity)throw new O(n(`server.err.chestFull`),409);p[i]-=d,p[i]<=0&&delete p[i],m[i]=(m[i]||0)+d}else if(o===`withdraw`){if((m[i]||0)<d)throw new O(n(`server.err.notEnoughInChest`,{resource:i}));if(A(p)+d>Et(l))throw new O(n(`server.err.basketFull`),409);m[i]-=d,m[i]<=0&&delete m[i],p[i]=(p[i]||0)+d}else throw new O(n(`server.err.badDirection`));return await s.Player.patch(t,{inventory:p}),await s.Chest.patch(r,{contents:m}),await J(l,o===`deposit`?{chestDeposits:1}:{chestWithdrawals:1}),{ok:!0,inventory:p,chest:{...f,contents:m}}}},Qn=class extends ${async post(e){let{playerId:t,kind:r,id:i,qty:a}=await Z(e),o=D(),{player:s}=await K(t),c=ce(a,`qty`);if(!i||typeof i!=`string`)throw new O(n(`server.err.idRequired`));if(r===`crafted`){let e={...s.craftedItems||{}};if((e[i]||0)<c)throw new O(n(`server.err.discardTooMany`));return e[i]-=c,e[i]<=0&&delete e[i],await o.Player.patch(t,{craftedItems:e}),await J(s,{itemsDiscarded:c}),{ok:!0,craftedItems:e}}let l={...s.inventory||{}};if((l[i]||0)<c)throw new O(n(`server.err.discardTooMany`));return l[i]-=c,l[i]<=0&&delete l[i],await o.Player.patch(t,{inventory:l}),await J(s,{itemsDiscarded:c}),{ok:!0,inventory:l}}},$n=class extends ${async post(e){let{playerId:t,recipeId:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=P(o),c=a.recipe.get(r);if(!c)throw new O(n(`server.err.unknownRecipe`,{recipe:r}));let l=a.object.get(c.output.itemId);if(l?.plantable)throw new O(n(`server.err.plantedNotCrafted`,{name:c.name}),400);if(!o.devUnlockAll&&l?.homeMin&&(W(o).space||1)<l.homeMin)throw new O(n(`server.err.needsProperHouse`,{name:c.name}),403);let u=!!o.devUnlockAll;if(!u&&c.unlockBiome&&!(o.unlockedBiomes||[]).includes(c.unlockBiome))throw new O(n(`server.err.recipeBiomeLocked`),403);if(!u&&c.unlock&&c.unlockBiome&&!Yt(c,await Xt(s,c.unlockBiome,o,a)))throw new O(n(`server.err.recipeLocked`,{label:c.unlock.label}),403);if(c.requiresTool&&(o.tools?.[c.requiresTool.id]||1)<c.requiresTool.tier){let e=a.tool.get(c.requiresTool.id);throw new O(n(`server.err.requiresUpgradedTool`,{tool:e?.name||c.requiresTool.id}),403)}if(c.once&&(o.craftedEver?.[c.output.itemId]||0)>0)throw new O(n(`server.err.craftOnce`,{name:c.name}),409);let{usedFrom:d,inventory:f}=await Qt(o,c.materials||{},s),p=De(o),m;if(p?.id===`thrift`&&Object.keys(c.materials||{}).length&&Math.random()<p.strength){let e=Et(o)-A(f);for(let[t,n]of Object.entries(c.materials||{})){let r=Math.min(Math.max(1,Math.floor(n/2)),Math.max(0,e));r>0&&(m||={},m[t]=r,f[t]=(f[t]||0)+r,e-=r)}}let h={...o.craftedItems||{}},g={...o.craftedEver||{}};h[c.output.itemId]=(h[c.output.itemId]||0)+(c.output.qty||1),g[c.output.itemId]=(g[c.output.itemId]||0)+(c.output.qty||1),await i.Player.patch(t,m?{craftedItems:h,craftedEver:g,inventory:f}:{craftedItems:h,craftedEver:g});let _=await Jt(s,t,{player:{...o,craftedItems:h,craftedEver:g}}),v=await F(i.Chest,s);return await J(o,{itemsCrafted:1},{craft:1}),await Q(t),{ok:!0,crafted:c.output,craftedItems:h,inventory:f,chests:v,usedFrom:d,refund:m,unlockedBiomes:_}}};function er(e){let t=Number(e);return Number.isFinite(t)?(Math.round(t/90)*90%360+360)%360:0}var tr=new Set([`wooden-fence`,`dry-stone-wall`,`wooden-bench`,`hammock`,`picnic-blanket`,`garden-arch`,`trail-signpost`,`flower-cart`,`home-bed`,`home-sleeping-bag`,`home-bookshelf`,`home-armchair`,`home-fireplace`,`home-table`,`home-dresser`,`home-driftwoodshelf`,`home-mushroomshelf`,`home-reedmat`,`home-peltrug`,`home-rug`,`home-cushions`,`home-stool`,`home-aquarium`,`home-telescope`]);function nr(e){return e?e.rotatable===!0||e.bridge||/-path$/.test(e.id)?!0:tr.has(e.id):!1}var rr=class extends ${async post(e){let{playerId:t,objectId:r,area:i,x:a,y:o,rotation:s}=await Z(e),c=D(),l=await B(),{player:u}=await K(t),d=P(u),f=l.object.get(r);if(!f)throw new O(n(`server.err.unknownObject`,{object:r}));if(f.placement===`none`)throw new O(n(`server.err.kitNotPlaceable`,{name:f.name}));if((u.craftedItems?.[r]||0)<=0)throw new O(n(`server.err.noneCrafted`,{name:f.name}));let p=Math.round(Number(a)),m=Math.round(Number(o)),h=gt(l,i);if(!Number.isFinite(p)||!Number.isFinite(m)||p<1||m<1||p>h.cols-2||m>h.rows-2)throw new O(n(`server.err.outOfReach`));let g=Ae(i);if(i===`home`){if(f.placement===`outdoor`)throw new O(n(`server.err.outdoorOnly`,{name:f.name}));if(f.homeMin&&(W(u).space||1)<f.homeMin)throw new O(n(`server.err.needsBiggerHome`,{name:f.name}),403);let e=Oe(u);if(p<e.x0||p>e.x1||m<e.y0||m>e.y1)throw new O(n(`server.err.placeOnFloor`))}else if(g){let e=l.biome.get(g);if(!e)throw new O(n(`server.err.unknownArea`,{area:i}));if(!(u.unlockedBiomes||[]).includes(g))throw new O(n(`server.err.biomeLocked`,{biome:e.name}),403);if(f.placement===`outdoor`)throw new O(n(`server.err.outdoorOnly`,{name:f.name}));if(f.homeMin&&f.homeMin>1)throw new O(n(`server.err.tentTooSmall`,{name:f.name}),403);let t=je();if(p<t.x0||p>t.x1||m<t.y0||m>t.y1)throw new O(n(`server.err.placeOnFloor`))}else{let e=l.biome.get(i);if(!e)throw new O(n(`server.err.unknownArea`,{area:i}));if(!(u.unlockedBiomes||[]).includes(i))throw new O(n(`server.err.biomeLocked`,{biome:e.name}),403);if(f.placement===`indoor`)throw new O(n(`server.err.indoorOnly`,{name:f.name}));if(!(f.biomes||[]).includes(i))throw new O(n(`server.err.wrongHabitat`,{name:f.name,biome:e.name}));if(e.oceanCols&&p>=h.cols-e.oceanCols)throw new O(n(`server.err.openOcean`),409)}if(f.requiresTool&&(u.tools?.[f.requiresTool.id]||1)<f.requiresTool.tier)throw new O(n(`server.err.placeRequiresTool`,{name:f.name,tool:l.tool.get(f.requiresTool.id)?.name||f.requiresTool.id}),403);let _=await F(c.Placement,d);if(_.some(e=>e.area===i&&e.x===p&&e.y===m))throw new O(n(`server.err.spotTaken`),409);if(f.onePerArea&&_.some(e=>e.area===i&&e.objectId===r))throw new O(n(`server.err.onePerArea`,{name:f.name}),409);let v=i===`home`||!!g,y=v?null:await I(c.TerrainTile,d,i,p,m);if(y)if(y.type===`water`){if(!f.bridge)throw new O(n(`server.err.openWaterBridge`),409)}else throw new O(n(`server.err.bedForPlanting`),409);else if(f.bridge&&!v)throw new O(n(`server.err.bridgeNeedsWater`),409);let b={...u.craftedItems||{}};--b[r],b[r]<=0&&delete b[r],await c.Player.patch(t,{craftedItems:b});let x=`pl_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,S={id:x,worldId:d,playerId:t,objectId:r,area:i,x:p,y:m,placedAt:Date.now(),rotation:nr(f)?er(s):0};if(await c.Placement.put(S),f.isChest&&await c.Chest.put({id:x,worldId:d,playerId:t,area:i,x:p,y:m,size:r,capacity:f.chestCapacity||60,contents:{}}),v)return await J(u,{objectsPlaced:1},{place:1}),await Q(t),{ok:!0,placement:S,craftedItems:b};let C=await X(d,t,i,{addPlacements:[S],player:{...u,craftedItems:b}});return await J(u,{objectsPlaced:1,animalsReturned:C.newAnimals?.length||0},{place:1}),await En(d,t,{addDiscoveries:C.newAnimals,freshBiomeStates:[C.biomeState]}),{ok:!0,placement:S,craftedItems:b,...C}}},ir=class extends ${async post(e){let{playerId:t,area:r,x:i,y:a,plantId:o}=await Z(e),s=D(),c=await B(),{player:l}=await K(t),u=P(l),d=c.biome.get(r);if(!d)throw new O(n(`server.err.unknownArea`,{area:r}));if(!(l.unlockedBiomes||[]).includes(r))throw new O(n(`server.err.biomeLocked`,{biome:d.name}),403);let f=c.object.get(o);if(!f||!f.plantable)throw new O(n(`server.err.notPlantable`));if(!(f.biomes||[]).includes(r))throw new O(n(`server.err.wouldNotTakeRoot`,{name:f.name,biome:d.name}));let p=Math.round(Number(i)),m=Math.round(Number(a)),h=await I(s.TerrainTile,u,r,p,m);if(!h||h.type!==`watered`)throw new O(n(`server.err.plantIntoWatered`));let{usedFrom:g,inventory:_}=await Qt(l,f.plantCost||{},u);await s.TerrainTile.delete(h.id);let v=De(l),y=v?.id===`growth`?v.strength:0,b=Date.now(),x={id:`pl_${b}_${Math.random().toString(36).slice(2,8)}`,worldId:u,playerId:t,objectId:o,area:r,x:p,y:m,placedAt:b-Math.round(Mt(f)*y),plantedAt:b-Math.round((f.growSeconds||0)*1e3*y)};await s.Placement.put(x);let S=await X(u,t,r,{addPlacements:[x],removeTerrainIds:[h.id],player:{...l,inventory:_}});return await J(l,{plantsPlanted:1,animalsReturned:S.newAnimals?.length||0},{plant:1}),await En(u,t,{addDiscoveries:S.newAnimals,freshBiomeStates:[S.biomeState]}),{ok:!0,placement:x,inventory:_,usedFrom:g,perkGrowth:y||void 0,...S}}};function ar(e,t){let n=e?.yield;if(!n||!e?.plantable||!t?.plantedAt)return null;let r=(e.growSeconds||0)*1e3,i=(n.regrowSeconds||60)*1e3;return t.lastHarvestAt?t.lastHarvestAt+i:t.plantedAt+r}var or=class extends ${async post(e){let{playerId:t,placementId:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=P(o),c=Date.now(),l=(await F(i.Placement,s)).find(e=>e.id===r);if(!l)throw new O(n(`server.err.placementNotFound`),404);let u=a.object.get(l.objectId),d=u?.yield;if(!d)throw new O(n(`server.err.notHarvestable`));let f=ar(u,l);if(f==null||c<f)throw new O(n(`server.err.notReadyYet`));let p=Et(o),m={...o.inventory||{}},h=Math.max(0,p-A(m)),g=Math.min(d.qty||1,h);if(g<=0)throw new O(n(`server.err.basketFullHarvest`),409);return m[d.resourceId]=(m[d.resourceId]||0)+g,await i.Player.patch(t,{inventory:m}),await i.Placement.patch(r,{lastHarvestAt:c}),await J(o,{resourcesCollected:g}),{ok:!0,placementId:r,gained:{[d.resourceId]:g},inventory:m,placement:{...l,lastHarvestAt:c}}}},sr=class extends ${async post(e){let{playerId:t,appearance:n}=await Z(e),{player:r}=await K(t),i=Ge(n);return await D().Player.patch(t,{appearance:i}),await J(r,{appearanceChanges:1}),{ok:!0,appearance:i}}},cr=class extends ${async post(e){let{playerId:t,placementId:r,x:i,y:a,rotation:o}=await Z(e),s=D(),{player:c}=await K(t),l=P(c),u=await F(s.Placement,l),d=u.find(e=>e.id===r);if(!d)throw new O(n(`server.err.placementNotFound`),404);if(d.objectId===`workbench`)throw new O(n(`server.err.workbenchStays`));let f=gt(await B(),d.area),p=Math.round(Number(i)),m=Math.round(Number(a));if(!Number.isFinite(p)||!Number.isFinite(m)||p<1||m<1||p>f.cols-2||m>f.rows-2)throw new O(n(`server.err.outOfReach`));if(u.some(e=>e.id!==r&&e.area===d.area&&e.x===p&&e.y===m))throw new O(n(`server.err.spotTaken`),409);let h=await B(),g=h.object.get(d.objectId),_=await I(s.TerrainTile,l,d.area,p,m);if(_)if(_.type===`water`){if(!g?.bridge)throw new O(n(`server.err.openWaterBridgeOnly`),409)}else throw new O(n(`server.err.bedForPlantingShort`),409);else if(g?.bridge)throw new O(n(`server.err.bridgesOverWater`),409);let v={x:p,y:m};return o!==void 0&&nr(g)&&(v.rotation=er(o)),await s.Placement.patch(r,v),await Zt(s,h,r,l)&&await s.Chest.patch(r,{x:p,y:m}),await J(c,{objectsMoved:1}),{ok:!0,placement:{...d,...v}}}},lr=class extends ${async post(e){let{playerId:t,placementId:r}=await Z(e),i=D(),{player:a}=await K(t),o=P(a),s=await fe(i.Placement,o,r);if(!s)throw new O(n(`server.err.placementNotFound`),404);if(s.objectId===`workbench`)throw new O(n(`server.err.workbenchStays`));let c=await fe(i.Chest,o,r);if(c&&A(c.contents)>0)throw new O(n(`server.err.emptyChestFirst`),409);if(s.objectId===`trail-tent`){let e=`tent-${s.area}`;if((await F(i.Placement,o)).some(t=>t.area===e))throw new O(n(`server.err.tentNotEmpty`),409)}let l=(await B()).object.get(s.objectId),u=null,d={...a.craftedItems||{}},f={...a.inventory||{}},p=new Map;if(l?.plantable&&s.plantedAt&&Object.keys(l.plantCost||{}).length){u={...l.plantCost};let e=Et(a),t=A(f),s=(await F(i.Chest,o)).filter(e=>e.id!==r);for(let[r,i]of Object.entries(u)){let a=i,o=Math.min(a,Math.max(0,e-t));o>0&&(f[r]=(f[r]||0)+o,t+=o,a-=o);for(let e of s){if(a<=0)break;let t=p.get(e.id)||{...e.contents||{}},n=e.capacity-A(t),i=Math.min(n,a);i>0&&(t[r]=(t[r]||0)+i,p.set(e.id,t),a-=i)}if(a>0)throw new O(n(`server.err.noRoomRefund`),409)}}else d[s.objectId]=(d[s.objectId]||0)+1;if(c&&await i.Chest.delete(r),await i.Placement.delete(r),u){await i.Player.patch(t,{inventory:f});for(let[e,t]of p)await i.Chest.patch(e,{contents:t})}else await i.Player.patch(t,{craftedItems:d});let m=s.area!==`home`&&!Ae(s.area)?await X(o,t,s.area,{removeIds:[r],player:{...a,craftedItems:d,inventory:f}}):null;return await J(a,{objectsRemoved:1,animalsReturned:m?.newAnimals?.length||0}),await En(o,t,m?{addDiscoveries:m.newAnimals,freshBiomeStates:[m.biomeState]}:{}),{ok:!0,removed:r,craftedItems:d,refunded:u,...m||{}}}},ur=class extends ${async post(e){let{playerId:t,toolId:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=a.tool.get(r);if(!s)throw new O(n(`server.err.unknownTool`,{tool:r}));let c=P(o),l=o.tools?.[r]||1,u=(s.tiers||[]).find(e=>e.tier===l+1);if(!u)throw new O(n(`server.err.toolMaxed`,{tool:s.name}));if(u.requires?.biome&&((await pe(i.BiomeState,c,u.requires.biome))?.health||0)<(u.requires.minHealth||0)){let e=a.biome.get(u.requires.biome);throw new O(n(`server.err.restoreFirst`,{biome:e?.name||u.requires.biome,health:u.requires.minHealth}),403)}let{usedFrom:d,inventory:f}=await Qt(o,u.materials||{},c),p={...o.tools||{},[r]:u.tier};await i.Player.patch(t,{tools:p});let m=await Jt(c,t,{player:{...o,tools:p}}),h=await F(i.Chest,c);return await J(o,{toolsUpgraded:1}),await Q(t),{ok:!0,tools:p,inventory:f,chests:h,usedFrom:d,unlockedBiomes:m,upgraded:{toolId:r,tier:u.tier,name:u.name}}}},dr=class extends ${async post(e){let{playerId:t,track:r}=await Z(e),i=D(),{player:a}=await K(t),o=P(a),s=U[r];if(!s)throw new O(n(`server.err.unknownHomeUpgrade`));let c=W(a);if(!c.styleLocked)throw new O(n(`server.err.buildStyleFirst`),403);let l=c[r]||1,u=s.levels[l];if(!u)throw new O(n(`server.err.trackMaxed`,{track:s.name.toLowerCase()}));if(u.requires?.biome&&((await pe(i.BiomeState,o,u.requires.biome))?.health||0)<(u.requires.minHealth||0)){let e=(await B()).biome.get(u.requires.biome);throw new O(n(`server.err.restoreFirst`,{biome:e?.name||u.requires.biome,health:u.requires.minHealth}),403)}let{usedFrom:d,inventory:f}=await Qt(a,u.materials||{},o),p={...c,[r]:l+1};await i.Player.patch(t,{home:p});let m=await F(i.Chest,o);return await Q(t),await J(a,{homeUpgrades:1}),{ok:!0,home:p,inventory:f,chests:m,usedFrom:d,upgraded:{track:r,level:l+1,name:s.name}}}},fr=[`home-sleeping-bag`,`home-bed`],pr=class extends ${async post(e){let{playerId:t}=await Z(e),r=D(),{player:i}=await K(t),a=P(i);if(!(await F(r.Placement,a)).some(e=>fr.includes(e.objectId)))throw new O(n(`server.err.needBedToRest`),403);let o=await F(r.NodeState,a);for(let e of o)await r.NodeState.delete(e.id);let s=E(i),c=f(s)-s;return await r.Player.patch(t,{clockOffsetMs:(i.clockOffsetMs||0)+c}),await J(i,{restsTaken:1}),{ok:!0,rested:!0,refreshed:o.length}}},mr=e=>typeof e==`string`&&/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e.trim()),hr=class extends ${async post(e){let{playerId:t,colors:r}=await Z(e),i=D(),{player:a}=await K(t),o=W(a);if(!o.styleLocked)throw new O(n(`server.err.buildBeforeRepaint`),403);let s={...o.colors};for(let e of[`floor`,`wall`,`accent`,`rug`])r?.[e]&&mr(r[e])&&(s[e]=String(r[e]).trim().toLowerCase());return await i.Player.patch(t,{home:{...o,colors:s}}),await J(a,{recolors:1}),{ok:!0}}},gr=class extends ${async post(e){let{playerId:t,placementId:r,color:i}=await Z(e),a=D(),{player:o}=await K(t);if(!W(o).styleLocked)throw new O(n(`server.err.buildBeforeRepaintThings`),403);if(!mr(i))throw new O(n(`server.err.invalidColor`));if(!await fe(a.Placement,P(o),r))throw new O(n(`server.err.itemNotHere`),404);return await a.Placement.patch(r,{color:String(i).trim().toLowerCase()}),await J(o,{recolors:1}),{ok:!0}}},_r=class extends ${async post(e){let{playerId:t,style:r}=await Z(e),i=D(),{player:a}=await K(t),o=H[r];if(!o)throw new O(n(`server.err.unknownHomeStyle`));let s=W(a);if(s.styleLocked)throw new O(n(`server.err.homeAlreadyBuilt`),403);let c=P(a);if(o.requires?.biome&&((await pe(i.BiomeState,c,o.requires.biome))?.health||0)<(o.requires.minHealth||0)){let e=(await B()).biome.get(o.requires.biome);throw new O(n(`server.err.restoreFirst`,{biome:e?.name||o.requires.biome,health:o.requires.minHealth}),403)}let{usedFrom:l,inventory:u}=await Qt(a,o.materials||{},c),d={...s,style:r,styleLocked:!0,space:2};await i.Player.patch(t,{home:d});let f=await F(i.Chest,c);return await Q(t),await J(a,{homesBuilt:1}),{ok:!0,home:d,inventory:u,chests:f,usedFrom:l,built:H[r].name}}},vr=class extends ${async post(e){let{playerId:t,animalId:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=P(o),c=await me(i.Discovery,s,r);if(!c)throw new O(n(`server.err.animalNotReturned`),404);let l=ut(o,Date.now()),u=c.lastObservedDayKey!==l,d=(c.timesObserved||0)+1;return await i.Discovery.patch(c.id,{timesObserved:d,lastObservedDayKey:l}),await J(o,{animalsObserved:1},u?{observe:1}:{}),await Q(t),{ok:!0,discovery:{...c,timesObserved:d},animal:a.animal.get(r)}}},yr=class extends ${async post(e){let{playerId:t,taskId:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=P(o),c=Date.now(),[l,u,d,f]=await Promise.all([F(i.Discovery,s),F(i.BiomeState,s),F(i.Placement,s),F(i.Chest,s)]),p=xn({wid:s,player:o,d:a,discoveries:l,biomeStates:u,placements:d,chests:f,now:c,unlockedBiomes:o.unlockedBiomes}),m=p.tasks.find(e=>e.id===String(r||``));if(!m)throw new O(n(`server.err.taskNotOnBoard`),404);if(m.pinned)throw new O(n(`server.err.taskNotClaimable`),409);if(m.claimed)throw new O(n(`server.err.taskAlreadyClaimed`),409);if(m.progress<m.target)throw new O(n(`server.err.taskNotFinished`),409);let h=Et(o),g={...o.inventory||{}},_=Math.max(0,h-A(g)),v={};for(let[e,t]of Object.entries(m.reward||{})){let n=Math.min(t,_);n<=0||(g[e]=(g[e]||0)+n,v[e]=n,_-=n)}if(!Object.keys(v).length)throw new O(n(`server.err.basketFullReward`),409);let y=String(m.id).startsWith(`start-`),b=String(m.id).startsWith(`unlock-reward:`),x={inventory:g};if(b){let e=String(m.id).slice(14);x.pendingUnlockRewards=(o.pendingUnlockRewards||[]).filter(t=>t!==e)}else y?x.goalClaims={...o.goalClaims||{},[m.id]:!0}:x.customGoals=(o.customGoals||[]).filter(e=>e.id!==m.id);await i.Player.patch(t,x),await J(o,{tasksCompleted:1}),await Q(t);let S={...p,tasks:p.tasks.map(e=>e.id===m.id?{...e,claimed:!0}:e)};return{ok:!0,taskId:m.id,text:m.text,gained:v,inventory:g,dailyTasks:S}}},br=class extends ${async post(e){let{playerId:t,goals:n}=await Z(e),{player:r}=await K(t),i=D(),a=await B(),o=P(r),s=Date.now(),[c,l,u,d]=await Promise.all([F(i.Discovery,o),F(i.BiomeState,o),F(i.Placement,o),F(i.Chest,o)]),f={wid:o,player:r,d:a,discoveries:c,biomeStates:l,placements:u,chests:d,now:s,unlockedBiomes:r.unlockedBiomes},p=new Map((r.customGoals||[]).map(e=>[e.id,e])),m=nn(r,a),h=bn(n,a),g=[];for(let e of h){let t=p.get(e.id);if(!t&&g.length>=m)continue;if(g.length>=tn)break;let n=t&&typeof t.base==`number`?t.base:gn(e,f),r={...e,base:n};e.kind===`build`&&(r.basePlace=t&&typeof t.basePlace==`number`?t.basePlace:mn(f,e.itemId||``)),g.push(r)}return await i.Player.patch(t,{customGoals:g}),{ok:!0,customGoals:g,goalLimit:m}}},xr=class extends ${async post(e){let{playerId:t,area:r,x:i,y:a,action:o}=await Z(e),s=D(),c=await B(),{player:l}=await K(t),u=P(l),d=c.biome.get(r);if(!d)throw new O(n(`server.err.terraformOutdoors`));if(!(l.unlockedBiomes||[]).includes(r))throw new O(n(`server.err.biomeLocked`,{biome:d.name}),403);let f=Math.round(Number(i)),p=Math.round(Number(a)),m=gt(c,r);if(!Number.isFinite(f)||!Number.isFinite(p)||f<1||p<1||f>m.cols-2||p>m.rows-2)throw new O(n(`server.err.outOfReach`));if((await F(s.Placement,u)).some(e=>e.area===r&&e.x===f&&e.y===p))throw new O(n(`server.err.somethingPlaced`));let h=`${u}:${r}:${f}:${p}`,g=await I(s.TerrainTile,u,r,f,p),_=l.inventory||{},v=null,y,b=null;if(o===`dig`){if((l.tools?.shovel||0)<1)throw new O(n(`server.err.needShovel`));if(g)throw new O(n(`server.err.alreadyPrepared`));v={id:h,worldId:u,playerId:t,area:r,x:f,y:p,type:`tilled`,updatedAt:Date.now()},await s.TerrainTile.put(v);let e=d.digResources||[];if(e.length&&Math.random()<Me){let n=e[Math.floor(Math.random()*e.length)],r=Math.max(0,Et(l)-A(_)),i=Math.min(l.tools?.shovel||1,r);i>0&&(_={..._,[n]:(_[n]||0)+i},await s.Player.patch(t,{inventory:_}),b={resourceId:n,amount:i})}}else if(o===`water`){if((l.tools?.[`watering-can`]||0)<1)throw new O(n(`server.err.needWateringCan`));if(!g)throw new O(n(`server.err.prepareBedFirst`));if(g.type===`water`)throw new O(n(`server.err.alreadyOpenWater`));let e=g.type===`tilled`?`watered`:`water`;if(e===`water`&&d.canFlood===!1)throw new O(n(`server.err.tooDryToFlood`,{biome:d.name}));if((_.water||0)+(_[`clean-water`]||0)<1)throw new O(n(`server.err.needWater`,{count:1}));_={..._};let r=1;for(let e of[`water`,`clean-water`]){let t=Math.min(_[e]||0,r);t>0&&(_[e]-=t,_[e]<=0&&delete _[e],r-=t)}await s.Player.patch(t,{inventory:_}),v={...g,type:e,updatedAt:Date.now()},await s.TerrainTile.patch(g.id,{type:e,updatedAt:Date.now()})}else if(o===`clear`){if(!g)throw new O(n(`server.err.nothingToClear`));await s.TerrainTile.delete(g.id),y=g.id}else throw new O(n(`server.err.badTerraformAction`));let x=await X(u,t,r,{addTerrain:v?[v]:[],removeTerrainIds:y?[y]:[],player:{...l,inventory:_}});return await J(l,{terraformActions:1,animalsReturned:x.newAnimals?.length||0},o===`water`?{water:1}:{}),await En(u,t,{addDiscoveries:x.newAnimals,freshBiomeStates:[x.biomeState]}),{ok:!0,tile:v,removedId:y,dug:b,inventory:_,...x}}},Sr=class extends ${async post(e){let{playerId:t,biomeId:n}=await Z(e),{player:r}=await K(t),i=await X(P(r),t,n);return await En(P(r),t,{addDiscoveries:i.newAnimals,freshBiomeStates:[i.biomeState]}),{ok:!0,...i}}},Cr=class extends ${async post(e){let{playerId:t,x:r,y:i,area:a,tutorialStep:o}=await Z(e),s=D(),c=await B(),{player:l}=await K(t),u={};if(Number.isFinite(Number(r))&&(u.x=Number(r)),Number.isFinite(Number(i))&&(u.y=Number(i)),Number.isInteger(o)&&o>=0&&o<=99&&(u.tutorialStep=o,u.tutorialMaxStep=Math.max(l.tutorialMaxStep??0,l.tutorialStep??0,o)),a===`home`)u.area=`home`;else if(Ae(a)){let e=Ae(a),t=c.biome.get(e);if(!t)throw new O(n(`server.err.unknownArea`,{area:a}));if(!(l.unlockedBiomes||[]).includes(e))throw new O(n(`server.err.biomeLocked`,{biome:t.name}),403);let r=P(l);if(!(await F(s.Placement,r)).some(t=>t.area===e&&t.objectId===`trail-tent`))throw new O(n(`server.err.noTentHere`),404);u.area=a}else if(a){let e=c.biome.get(a);if(!e)throw new O(n(`server.err.unknownArea`,{area:a}));if(!(l.unlockedBiomes||[]).includes(a))throw new O(n(`server.err.biomeLocked`,{biome:e.name}),403);if(!e.explorable)throw new O(n(`server.err.notExplorable`,{biome:e.name}),403);u.area=a;let r=l.visitedBiomes||[`meadow`];if(r.includes(a)||(u.visitedBiomes=[...r,a]),Kt[a]){let e=P(l);(await F(s.TerrainTile,e)).some(e=>e.area===a)||(await qt(e,t,a),await X(e,t,a,{player:l}))}}return await s.Player.patch(t,u),u.tutorialStep!==void 0&&await Q(t),{ok:!0,player:Ke(await s.Player.get(t))}}},wr=class extends ${async post(e){let{playerId:t,entries:n}=await Z(e),{player:r}=await K(t),i=P(r),a=D(),o=Array.isArray(n)?n.slice(0,Se):[],s=0;for(let e of o){let n=String(e?.text||``).slice(0,500).trim();if(!n)continue;let r=Number(e?.at)||Date.now(),o=String(e?.icon||`leaf`).slice(0,40),c=`f_${i}_${r}_${Math.random().toString(36).slice(2,9)}`;await a.FeedEntry.put({id:c,worldId:i,playerId:t,at:r,icon:o,text:n}),s++}let c=(await F(a.FeedEntry,i)).sort((e,t)=>(e.at||0)-(t.at||0));if(c.length>Se)for(let e of c.slice(0,c.length-Se))await a.FeedEntry.delete(e.id);return{ok:!0,added:s}}},Tr=18e5,Er=9e4,Dr=class extends ${async post(e){let{playerId:t,language:n,edition:r}=await Z(e),i=D(),a=await B(),{player:o}=await K(t),s=Date.now(),c=q(o)||et(o.createdAt||s),l=typeof n==`string`&&n.trim()?n.trim().toLowerCase().slice(0,12):null,u=r===`demo`?`demo`:r===`full`?`full`:null,d=c.lastHeartbeatAt||0,f=s-d,p=c.playSeconds||0,m=c.sessions||0,h=c.curSessionSeconds||0,g={...c.areaSeconds||{}},_={...c.sessionLengths||{}},v=d===0||f>Tr;if(v){if(h>0){let e=at(h);_[e]=(_[e]||0)+1}h=0,m+=1}else{let e=Math.min(f,Er)/1e3;p+=e,h+=e;let t=o.area||`unknown`;g[t]=Y((g[t]||0)+e)}let y={...c,firstSeenAt:c.firstSeenAt||o.createdAt||s,lastSeenAt:s,lastHeartbeatAt:s,playSeconds:Math.round(p),sessions:m,curSessionSeconds:Math.round(h),areaSeconds:g,sessionLengths:_,...l?{language:l}:{},...u?{edition:c.edition===`demo`?`demo`:u}:{}};await i.Player.patch(t,{metrics:tt(y)});let b=P(o),x=null,S=[],C=[];try{let e=c.lastSeenAt||0,n=v&&e>0&&s-e>6e5,r=await F(i.Placement,b),l=d>0?d:s,u=new Set;for(let t of r)Pt(a.object.get(t.objectId),t,n?e:l,s)&&u.add(t.area);let f=await F(i.BiomeState,b),p=new Set(f.filter(e=>e.unlocked).map(e=>e.biomeId)),m=n?[...p]:[...u].filter(e=>p.has(e)),h=0;for(let e of m){let n=f.find(t=>t.biomeId===e)?.health||0,r=await X(b,t,e,{player:o});h+=Math.max(0,(r.biomeState?.health||0)-n),S.push(...r.newAnimals||[]),C.push(r.biomeState)}if((S.length||C.length)&&await En(b,t,{addDiscoveries:S,freshBiomeStates:C}),n){let t=r.filter(t=>{let n=a.object.get(t.objectId);return p.has(t.area)&&Pt(n,t,e,s)}).length;(t>0||S.length>0||h>0)&&(x={awayHours:Math.round((s-e)/36e5*10)/10,matured:t,healthGain:h,arrivals:S.map(e=>e.animal?.name).filter(Boolean)})}}catch(e){console.error(`heartbeat growth pass skipped:`,e)}return await Q(t),{ok:!0,metrics:dt({...o,metrics:y}),...S.length?{newAnimals:S}:{},...C.length?{biomeStates:C}:{},...x?{welcomeBack:x}:{}}}},Or=null,kr=3e4;function Ar(e){return String(e).split(/[^0-9]+/).filter(Boolean).map(e=>parseInt(e,10))}function jr(e,t){let n=Ar(e),r=Ar(t);if(!n.length&&!r.length)return e<t?-1:+(e>t);if(!n.length)return-1;if(!r.length)return 1;let i=Math.max(n.length,r.length);for(let e=0;e<i;e++){let t=n[e]??0,i=r[e]??0;if(t!==i)return t<i?-1:1}return 0}var Mr=class extends ${async get(e){let t=D(),r=String(this.getId?.()||e?.id||``).trim();if(r){let e=await t.Player.get(r);if(!e)throw new O(n(`server.err.noSaveWithId`),404);let i=await St(r),a=dt(e);return{player:{...a,biomeSummary:i.summary,activation:ft(a,i.summary,e),achievements:await Tn(r),biomes:i.biomes}}}let i=Date.now(),a;if(Or&&i-Or.at<kr)a=Or.all;else{let e=[];try{e=await M(t.SoloMetrics)}catch{}a=e.map(e=>{let t={};if(e.snapshot)try{t=typeof e.snapshot==`string`?JSON.parse(e.snapshot):e.snapshot}catch{t={}}let n=t.lastSeenAt||e.updatedAt||null,r=t.createdAt||e.createdAt||i,a=n?Y((i-n)/36e5):null,o=`dormant`;a!=null&&(a<=24?o=`active`:a<=168&&(o=`recent`));let s=t.playSeconds||0,c=Math.round(s+(t.creationMs||0)/1e3),l=Math.max(t.sessions||0,+((t.creationMs||0)>0));return{...t,playerId:e.id,name:e.name||t.name||null,solo:!0,platform:e.platform||null,os:e.os||null,language:e.language||t.language||null,version:e.version||null,build:e.build||null,lastSyncedAt:e.updatedAt||null,counts:t.counts||{},playSeconds:c,playMinutes:Math.round(c/60),avgSessionMinutes:l?Math.round(c/60/l):0,sessions:l,totalActions:t.totalActions||0,currentArea:t.currentArea||null,unlockedBiomes:t.unlockedBiomes||0,tutorialStep:t.tutorialStep||0,activation:t.activation||{},achievements:t.achievements||null,biomeSummary:t.biomeSummary||{biomesUnlocked:0,avgHealth:0,biomesFullyRestored:0,totalAnimalsReturned:0},areaSeconds:t.areaSeconds||{},sessionLengths:t.sessionLengths||{},creationMs:t.creationMs||0,creationSeconds:t.creationSeconds??(t.creationMs?Y(t.creationMs/1e3):null),timeToFirstActionSeconds:t.timeToFirstActionSeconds??null,appearance:t.appearance||null,createdAt:r,lastSeenAt:n,hoursSinceActive:a,minutesSinceActive:n?Y((i-n)/6e4):null,status:o,daysSinceJoined:Math.floor((i-r)/ot),isNewToday:i-r<=ot}}).sort((e,t)=>(t.lastSeenAt||0)-(e.lastSeenAt||0)||t.playSeconds-e.playSeconds),Or={at:i,all:a}}let o={};for(let e of a){let t=e.version||`unknown`;o[t]=(o[t]||0)+1}let s=Object.keys(o).sort((e,t)=>t.localeCompare(e,void 0,{numeric:!0})),c=[...new Set(a.map(e=>e.edition===`demo`?`demo`:`full`))].sort(),l=[...new Set(a.map(e=>e.platform||`unknown`))].sort(),u=new Set;try{let t=typeof e?.getAll==`function`?[...e.getAll(`exclude`),...e.getAll(`excludeName`)]:[];for(let e of t.flatMap(e=>String(e).split(`,`))){let t=e.trim().toLowerCase();t&&u.add(t)}}catch{}u.size&&(a=a.filter(e=>!u.has(String(e.name||``).trim().toLowerCase())));let d=``;try{let t=typeof e?.getAll==`function`?e.getAll(`version`):[];d=String(t&&t[0]||``).trim()}catch{}let f=`exact`;try{let t=typeof e?.getAll==`function`?e.getAll(`versionMode`):[];String(t&&t[0]||``).trim().toLowerCase()===`min`&&(f=`min`)}catch{}let p=!!d&&d.toLowerCase()!==`all`,m=e=>{if(!p)return!0;let t=e||`unknown`;return f===`min`?jr(t,d)>=0:t===d};p&&(a=a.filter(e=>m(e.version||`unknown`)));let h=t=>{try{let n=typeof e?.getAll==`function`?e.getAll(t):[];return String(n&&n[0]||``).trim()}catch{return``}},g=h(`edition`),_=h(`platform`);g&&g.toLowerCase()!==`all`&&(a=a.filter(e=>(e.edition===`demo`?`demo`:`full`)===g)),_&&_.toLowerCase()!==`all`&&(a=a.filter(e=>(e.platform||`unknown`)===_));let v=a.length||1,y=e=>Math.round(e/v*100),b={};for(let e of a)for(let[t,n]of Object.entries(e.counts))b[t]=(b[t]||0)+n;let x=a.reduce((e,t)=>e+t.playSeconds,0),S=a.reduce((e,t)=>e+t.sessions,0),C=a.reduce((e,t)=>e+t.totalActions,0),w={activeNow:a.filter(e=>e.minutesSinceActive!=null&&e.minutesSinceActive<=5).length,activeLast24h:a.filter(e=>e.status===`active`).length,activeLast7d:a.filter(e=>e.status===`active`||e.status===`recent`).length,dormant:a.filter(e=>e.status===`dormant`).length,newLast24h:a.filter(e=>i-e.createdAt<=ot).length,newLast7d:a.filter(e=>i-e.createdAt<=7*ot).length},T=e=>{let t={};for(let n of a){let r=e(n)||`unknown`;t[r]=(t[r]||0)+1}return t},ee=T(e=>e.language||`en`),te=T(e=>e.platform),ne=T(e=>e.os),re=T(e=>e.version),ie=T(e=>e.edition||`full`),ae=a.filter(e=>e.sessions>=2).length,E=(e,t)=>e.counts&&(e.counts[t]||0)>0,k={created:a.length,collected:a.filter(e=>e.activation?.collected||E(e,`resourcesCollected`)).length,terraformed:a.filter(e=>e.activation?.terraformed||E(e,`terraformActions`)).length,planted:a.filter(e=>e.activation?.planted||E(e,`plantsPlanted`)).length,crafted:a.filter(e=>e.activation?.crafted||E(e,`itemsCrafted`)).length,placed:a.filter(e=>e.activation?.placed||E(e,`objectsPlaced`)).length,attractedAnimal:a.filter(e=>e.activation?.attractedAnimal||(e.biomeSummary?.totalAnimalsReturned||0)>0).length,upgradedTool:a.filter(e=>e.activation?.upgradedTool||E(e,`toolsUpgraded`)).length,builtHome:a.filter(e=>e.activation?.builtHome||E(e,`homesBuilt`)).length,upgradedHome:a.filter(e=>e.activation?.upgradedHome||E(e,`homeUpgrades`)).length,unlockedSecondBiome:a.filter(e=>e.activation?.unlockedSecondBiome||(e.unlockedBiomes||0)>=2).length},oe={collected:y(k.collected),terraformed:y(k.terraformed),planted:y(k.planted),crafted:y(k.crafted),placed:y(k.placed),attractedAnimal:y(k.attractedAnimal),upgradedTool:y(k.upgradedTool),builtHome:y(k.builtHome),upgradedHome:y(k.upgradedHome),unlockedSecondBiome:y(k.unlockedSecondBiome)},se={};for(let e of a)e.currentArea&&(se[e.currentArea]=(se[e.currentArea]||0)+1);let ce=Object.entries(se).sort((e,t)=>t[1]-e[1])[0]?.[0]||null,A={};for(let e of a){let t=String(e.tutorialStep||0);A[t]=(A[t]||0)+1}let le=a.filter(e=>(e.biomeSummary?.biomesUnlocked||0)>0),ue=le.length?Math.round(le.reduce((e,t)=>e+(t.biomeSummary.avgHealth||0),0)/le.length):0,j=a.filter(e=>e.achievements),de=j.reduce((e,t)=>e+(t.achievements.earned||0),0),N={},P={},F={};for(let e of j){for(let t of e.achievements.recent||[])t?.id&&(N[t.id]=(N[t.id]||0)+1);for(let[t,n]of Object.entries(e.achievements.byCategory||{}))P[t]=(P[t]||0)+n;let t=e.achievements.earned||0,n=t===0?`0`:`${Math.floor((t-1)/10)*10+1}-${(Math.floor((t-1)/10)+1)*10}`;F[n]=(F[n]||0)+1}let fe={totalDefined:j.reduce((e,t)=>Math.max(e,t.achievements.total||0),0),totalEarned:de,avgPerPlayer:Y(de/(j.length||1)),avgCompletionPct:j.length?Math.round(j.reduce((e,t)=>e+(t.achievements.completion||0),0)/j.length*100):0,avgPoints:Y(j.reduce((e,t)=>e+(t.achievements.points||0),0)/(j.length||1)),byCategory:P,recentDistribution:N,completionHistogram:F},I={};for(let e of a)for(let[t,n]of Object.entries(e.areaSeconds||{}))I[t]=(I[t]||0)+n;let pe=Object.values(I).reduce((e,t)=>e+t,0),me={};for(let[e,t]of Object.entries(I))me[e]=Math.round(t/60);let he={totalSeconds:Math.round(pe),byAreaSeconds:I,byAreaMinutes:me,mostTimeArea:Object.entries(I).sort((e,t)=>t[1]-e[1])[0]?.[0]||null},L={"<2m":0,"2-10m":0,"10-30m":0,"30m+":0};for(let e of a)for(let[t,n]of Object.entries(e.sessionLengths||{}))L[t]=(L[t]||0)+n;let R=a.filter(e=>(e.creationMs||0)>0),ge={savesWithTiming:R.length,avgCreationSeconds:R.length?Y(R.reduce((e,t)=>e+t.creationMs,0)/R.length/1e3):0,medianCreationSeconds:R.length?Y([...R].map(e=>e.creationMs).sort((e,t)=>e-t)[Math.floor(R.length/2)]/1e3):0},_e={},z=(e,t)=>{if(t==null||t===``)return;let n=String(t);(_e[e]||={})[n]=(_e[e][n]||0)+1};for(let e of a){let t=e.appearance;t&&(z(`skin`,t.skin),z(`hair`,t.hair),z(`outfit`,t.outfit),z(`hat`,t.hat),z(`hatColor`,t.hatColor),z(`hairstyle`,t.hairstyle),z(`beard`,t.beard),z(`body`,t.body))}let ve={savesWithAppearance:a.filter(e=>e.appearance).length,choices:_e},ye=a.filter(e=>e.timeToFirstActionSeconds!=null),B={playersMeasured:ye.length,avgSeconds:ye.length?Y(ye.reduce((e,t)=>e+t.timeToFirstActionSeconds,0)/ye.length):0},be=a.filter(e=>e.prefs&&typeof e.prefs==`object`),xe=be.length||1,V=e=>be.filter(t=>e(t.prefs)).length,Se=e=>{let t={};for(let n of be){let r=e(n.prefs)||`unknown`;t[r]=(t[r]||0)+1}return t},Ce=V(e=>e.musicEnabled===!1),H=V(e=>e.sfxEnabled===!1),we={savesReporting:be.length,audio:{musicOff:Ce,sfxOff:H,fullyMuted:V(e=>e.musicEnabled===!1&&e.sfxEnabled===!1),musicOffPct:Math.round(Ce/xe*100),sfxOffPct:Math.round(H/xe*100)},accessibility:{reduceMotion:V(e=>e.reduceMotion===!0),dyslexiaFont:V(e=>e.dyslexiaFont===!0),colorblindOn:V(e=>e.colorblindMode&&e.colorblindMode!==`off`),anyEnabled:V(e=>e.reduceMotion===!0||e.dyslexiaFont===!0||e.colorblindMode&&e.colorblindMode!==`off`||e.textScale&&e.textScale!==`md`),colorblindModes:Se(e=>e.colorblindMode||`off`),textScales:Se(e=>e.textScale||`md`)}},U=[];try{U=await M(t.AppOpen)}catch{}p&&(U=U.filter(e=>m(e.version||`unknown`))),g&&g.toLowerCase()!==`all`&&(U=U.filter(e=>(e.edition===`demo`?`demo`:`full`)===g)),_&&_.toLowerCase()!==`all`&&(U=U.filter(e=>(e.platform||`unknown`)===_));let W=U.length,Te=U.filter(e=>e.converted).length,Ee=U.filter(e=>e.edition===`demo`),De=Ee.filter(e=>e.converted).length,Oe=Ee.filter(e=>e.reachedDemoGoal).length,ke={demoInstalls:Ee.length,createdCharacter:De,reachedGoal:Oe,completionPct:De?Math.round(Oe/De*100):0},Ae={};for(let e of U){let t=e.edition===`demo`?`demo`:`full`;Ae[t]=(Ae[t]||0)+1}let je=U.filter(e=>(e.creationMs||0)>0),Me=U.reduce((e,t)=>e+(t.savesCreated||0),0),Ne={};for(let e of U){let t=String(e.savesCreated||0);Ne[t]=(Ne[t]||0)+1}let Pe={devices:W,totalOpens:U.reduce((e,t)=>e+(t.opens||0),0),converted:Te,bounced:W-Te,conversionPct:W?Math.round(Te/W*100):0,bounceRatePct:W?Math.round((W-Te)/W*100):0,avgCreatorSeconds:je.length?Y(je.reduce((e,t)=>e+t.creationMs,0)/je.length/1e3):0,totalCharactersCreated:Me,avgCharactersPerPerson:W?Y(Me/W):0,avgCharactersPerConverted:Te?Y(Me/Te):0,charactersPerPersonHistogram:Ne,editions:Ae};return{generatedAt:i,source:`solo-metrics`,filters:{availableVersions:s,availableEditions:c,availablePlatforms:l,version:p?d:null,versionMode:p?f:null,edition:g&&g.toLowerCase()!==`all`?g:null,platform:_&&_.toLowerCase()!==`all`?_:null},summary:{players:a.length,soloPlayers:a.length,excludedNames:[...u],audience:w,languages:ee,platforms:te,operatingSystems:ne,versions:re,editions:ie,engagement:{totalPlayHours:Y(x/3600),totalPlaySeconds:x,avgPlayMinutesPerPlayer:Math.round(x/60/v),totalSessions:S,avgSessionsPerPlayer:Y(S/v),avgSessionMinutes:S?Math.round(x/60/S):0,totalActions:C,avgActionsPerPlayer:Y(C/v)},retention:{returningPlayers:ae,returningRatePct:y(ae)},progression:{avgBiomeHealth:ue,biomesFullyRestored:a.reduce((e,t)=>e+(t.biomeSummary?.biomesFullyRestored||0),0),avgUnlockedBiomes:Y(a.reduce((e,t)=>e+(t.unlockedBiomes||0),0)/v),mostPopularArea:ce,tutorialStepHistogram:A},areaDwell:he,sessionLengthDistribution:L,creation:ge,appearancePopularity:ve,timeToFirstAction:B,acquisition:Pe,demoCompletion:ke,settings:we,funnel:k,funnelPct:oe,actionTotals:b,achievements:fe},players:a}}},Nr=class extends ${async get(){let e=String(this.getId?.()||``).trim();if(!e)throw new O(n(`server.err.snapshotPathId`));await K(e);let t=D(),r=await B(),i=(await N(t.BiomeState,e)).filter(e=>e.unlocked),a=await N(t.Placement,e),o=await N(t.TerrainTile,e);return{ok:!0,playerId:e,areas:i.map(e=>{let t=r.biome.get(e.biomeId),n=a.filter(t=>t.area===e.biomeId),i=o.filter(t=>t.area===e.biomeId),s=bt(r,t,e.health||0,n,i);return{area:e.biomeId,name:t?.name||e.biomeId,health:e.health||0,placements:n.length,image:xt(s),svg:s}})}}},Pr=class extends ${async post(e){let{playerId:t,action:r,area:i,amount:a,value:o,resources:s,animalId:c}=await Z(e),l=D(),u=await B(),{player:f}=await K(t),p=[];switch(r){case`set-time`:{let e=String(o||`dawn`),n=E(f),r=h(n,e)-n;await l.Player.patch(t,{clockOffsetMs:(f.clockOffsetMs||0)+r}),p.push(`Set time to ${e}`);break}case`reset-clock`:{let e=Math.round((q(f)?.playSeconds||0)*1e3);await l.Player.patch(t,{clockOffsetMs:h(0,`day`)-e}),p.push(`Reset the game clock to the first morning`);break}case`seed-water`:{let e=i||`wetland`;for(let n of(await N(l.TerrainTile,t)).filter(t=>t.area===e))await l.TerrainTile.delete(n.id);await qt(t,t,e),await X(t,t,e,{player:f}),p.push(`Reseeded starting terrain for ${e}`);break}case`clear-terrain`:{let e=i||f.area,n=0;for(let r of(await N(l.TerrainTile,t)).filter(t=>t.area===e))await l.TerrainTile.delete(r.id),n++;await X(t,t,e,{player:f}),p.push(`Cleared ${n} terrain tiles in ${e}`);break}case`grant-resources`:{let e={...f.inventory||{}},n=new Set(u.resources.map(e=>e.id)),r=0;if(s&&typeof s==`object`){for(let[t,i]of Object.entries(s)){let a=Math.floor(Number(i)||0);a>0&&n.has(t)&&(e[t]=(e[t]||0)+a,r++)}p.push(`Granted ${r} resource type${r===1?``:`s`}`)}else{let t=Math.max(1,Number(a)||200);for(let n of u.resources)e[n.id]=(e[n.id]||0)+t;p.push(`Granted ${t} of every resource`)}await l.Player.patch(t,{inventory:e});break}case`max-tools`:{let e={...f.tools||{}};for(let t of u.tools){let n=Math.max(...t.tiers.map(e=>e.tier));e[t.id]=n}await l.Player.patch(t,{tools:e}),p.push(`All tools set to max tier`);break}case`unlock-all`:{let e=u.biomes.map(e=>e.id);await l.Player.patch(t,{unlockedBiomes:e});for(let n of e)await l.BiomeState.patch(`${t}:${n}`,{unlocked:!0});p.push(`Unlocked all biomes (${e.length})`);break}case`unlock-next`:{let e=[...u.biomes].sort((e,t)=>(e.order||0)-(t.order||0)),n=new Set(f.unlockedBiomes||[`meadow`]),r=e.find(e=>!n.has(e.id));if(!r){p.push(`Every biome is already unlocked`);break}n.add(r.id),await l.Player.patch(t,{unlockedBiomes:[...n]}),await l.BiomeState.patch(`${t}:${r.id}`,{unlocked:!0}),await qt(t,t,r.id),p.push(`Unlocked the next area: ${r.name}`);break}case`relock-all`:await l.Player.patch(t,{unlockedBiomes:[`meadow`]});for(let e of u.biomes)await l.BiomeState.patch(`${t}:${e.id}`,{unlocked:e.id===`meadow`});p.push(`Re-locked every biome except the meadow`);break;case`reset-tools`:await l.Player.patch(t,{tools:{...Fe}}),p.push(`Tools reset to tier 1`);break;case`restart-game`:{let e=t;for(let e of await N(l.Placement,t))await l.Placement.delete(e.id);for(let e of await N(l.Chest,t))await l.Chest.delete(e.id);for(let e of await N(l.TerrainTile,t))await l.TerrainTile.delete(e.id);for(let e of await N(l.Discovery,t))await l.Discovery.delete(e.id);for(let e of await N(l.NodeState,t))await l.NodeState.delete(e.id);for(let e of await N(l.FeedEntry,t))await l.FeedEntry.delete(e.id);for(let e of await N(l.PlayerAchievement,t))await l.PlayerAchievement.delete(e.id);for(let n of u.biomes)await l.BiomeState.put({id:`${e}:${n.id}`,worldId:e,playerId:t,biomeId:n.id,health:xe,balance:0,returnedCount:0,unlocked:n.id===`meadow`});let n=`pl_${t}_starter-chest`;await l.Placement.put({id:n,worldId:e,playerId:t,objectId:`small-chest`,area:`meadow`,x:G.x,y:G.y,placedAt:Date.now()}),await l.Chest.put({id:n,worldId:e,playerId:t,area:`meadow`,x:G.x,y:G.y,size:`small-chest`,capacity:G.capacity,contents:{}}),await l.Player.patch(t,{area:`meadow`,x:24.5,y:6.5,inventory:{...Pe},craftedItems:{},craftedEver:{},tools:{...Fe},unlockedBiomes:[`meadow`],visitedBiomes:[`meadow`],tutorialStep:0,home:{...we},customGoals:[],goalClaims:{},devUnlockAll:!1,clockOffsetMs:h(0,`day`)-Math.round((q(f)?.playSeconds||0)*1e3)}),p.push(`Restarted the game — fresh save (name, passcode & look kept)`);break}case`build-home`:{let e=o&&H[o]?o:`cabin`,n={...W(f),style:e,space:Math.max(2,W(f).space||1),styleLocked:!0};await l.Player.patch(t,{home:n}),p.push(`Built home: ${H[e].name}`);break}case`max-home`:{let e={style:o&&H[o]?o:W(f).style||`cabin`,space:U.space.levels.length,comfort:U.comfort.levels.length,decor:U.decor.levels.length,light:U.light.levels.length,styleLocked:!0};await l.Player.patch(t,{home:e}),p.push(`Home maxed on every track`);break}case`reset-home`:await l.Player.patch(t,{home:{...we}}),p.push(`Home reset to the starter tent`);break;case`set-health`:{let e=i||f.area,n=Math.max(0,Math.min(100,Number(o)||100));await l.BiomeState.patch(`${t}:${e}`,{health:n}),p.push(`Set ${e} health to ${n}% (recomputes on next change)`);break}case`reset-biome`:{let e=i||f.area,n=0;for(let r of(await N(l.Placement,t)).filter(t=>t.area===e))u.object.get(r.objectId)?.isChest||(await l.Placement.delete(r.id),n++);for(let n of(await N(l.TerrainTile,t)).filter(t=>t.area===e))await l.TerrainTile.delete(n.id);let r=0;for(let n of(await N(l.Discovery,t)).filter(t=>t.biomeId===e))await l.Discovery.delete(n.id),r++;let a=`${t}:${e}:`;for(let e of(await N(l.NodeState,t)).filter(e=>String(e.id).startsWith(a)))await l.NodeState.delete(e.id);await l.BiomeState.patch(`${t}:${e}`,{health:xe,balance:0,returnedCount:0}),await qt(t,t,e),await X(t,t,e,{player:f}),p.push(`Reset ${e} to its damaged state — removed ${n} object${n===1?``:`s`} and sent ${r} animal${r===1?``:`s`} away (chests kept)`);break}case`lock-biome`:{let e=i||f.area;if(e===`meadow`)throw new O(n(`server.err.meadowCannotLock`));let r=(f.unlockedBiomes||[]).filter(t=>t!==e);await l.Player.patch(t,{unlockedBiomes:r}),await l.BiomeState.patch(`${t}:${e}`,{unlocked:!1}),p.push(`Locked ${e} again (unlock requirements must be met to re-enter)`);break}case`unlock-recipes`:{let e=o===void 0?!f.devUnlockAll:!!o;await l.Player.patch(t,{devUnlockAll:e}),p.push(e?`All recipes unlocked (gates ignored)`:`Recipe progress gates restored`);break}case`welcome-animals`:{let e=i||f.area,n=u.animals.filter(t=>t.biome===e),r=new Set((await N(l.Discovery,t)).filter(t=>t.biomeId===e).map(e=>e.animalId)),a=0;for(let i of n)r.has(i.id)||(await l.Discovery.put({id:`${t}:${i.id}`,playerId:t,animalId:i.id,biomeId:e,comfort:3,timesObserved:0,firstObservedAt:Date.now(),whyReturned:Gt(i,u)}),a++);await X(t,t,e,{player:f}),p.push(`Welcomed ${a} animal${a===1?``:`s`} to ${e} (${n.length} total)`);break}case`spawn-animal`:{let e=u.animals.find(e=>e.id===c);if(!e)throw new O(n(`server.err.unknownAnimal`,{animal:c}));let r=`${t}:${e.id}`;await l.Discovery.get(r)||await l.Discovery.put({id:r,playerId:t,animalId:e.id,biomeId:e.biome,comfort:85,timesObserved:1,firstObservedAt:Date.now(),whyReturned:Gt(e,u)});let i=f.unlockedBiomes||[`meadow`];i.includes(e.biome)||await l.Player.patch(t,{unlockedBiomes:[...i,e.biome]}),await X(t,t,e.biome,{player:f}),await l.Discovery.patch(r,{comfort:85}),p.push(`Spawned ${e.name} in ${e.biome} — comfort 85, biome unlocked`);break}case`populate-biome`:{let e=i||f.area,r=u.biome.get(e);if(!r||e===`home`)throw new O(n(`server.err.cannotPopulate`,{area:e}));let a=P(f),o=new Set(f.unlockedBiomes||[`meadow`]);o.has(e)||(o.add(e),await l.Player.patch(t,{unlockedBiomes:[...o]}));for(let t of(await F(l.Placement,a)).filter(t=>t.area===e))u.object.get(t.objectId)?.isChest||await l.Placement.delete(t.id);for(let t of(await F(l.TerrainTile,a)).filter(t=>t.area===e))await l.TerrainTile.delete(t.id);let s=gt(u,e),c=e===`alpine`?ht:0,d=(e===`coastal`?s.cols-(r.oceanCols||0):s.cols)-2,m=c+2,h=s.rows-2,g=(t,n)=>e===`meadow`&&t>=19&&t<=24&&n>=3&&n<=6,_=Date.now()-3888e6,v=se(oe(`populate:${a}:${e}`)),y=(e,t)=>e+Math.floor(v()*(t-e+1)),b=e=>e[Math.floor(v()*e.length)],x=new Set;(await F(l.Chest,a)).filter(t=>t.area===e).forEach(e=>x.add(`${e.x},${e.y}`));let S=(e,t)=>e>=2&&e<=d&&t>=m&&t<=h&&!g(e,t)&&!x.has(`${e},${t}`),C=[],w=(e,t)=>{S(e,t)&&(x.add(`${e},${t}`),C.push({x:e,y:t}))};if(r.canFlood!==!1){let e=y(3,Math.max(3,Math.min(d-4,10))),t=y(m+1,Math.max(m+1,Math.min(h-3,m+6)));for(let n=0;n<3;n++)for(let r=0;r<4;r++)(r!==0&&r!==3||n!==0&&n!==2)&&w(e+r,t+n);w(e+1,t-1),w(e+2,t+3);let n=y(Math.floor((2+d)/2),d-2),r=m;w(n,r);for(let e=0,t=y(13,18);e<t&&r<h;e++)v()<.25&&n>3&&n<d-1?n+=v()<.5?-1:1:r+=1,w(n,r),v()<.25&&w(Math.min(d,n+1),r)}let T=u.objects.filter(t=>(t.biomes||[]).includes(e)&&t.placement!==`indoor`&&t.placement!==`none`&&!t.isChest&&!t.bridge);if(!T.length)throw new O(n(`server.err.noPlaceableObjects`,{biome:r.name}));let ee=e=>/-path$/.test(e.id)||e.id===`wooden-fence`||e.id===`dry-stone-wall`,te=T.filter(e=>e.plantable&&(e.growSeconds||0)>=80),ne=T.filter(e=>e.plantable&&(e.growSeconds||0)<80),re=new Set([`shrub`,`rock-pile`,`hollow-log`,`log-shelter`,`brush-pile`,`stone-cairn`,`rock-cairn`,`clover-patch`,`butterfly-flowers`,`pollinator-garden`,`fallen-branch-shelter`,`insect-hotel`,`birdhouse`,`bird-perch`]),ie=T.filter(e=>!e.plantable&&!ee(e)&&re.has(e.id)),ae=T.filter(ee),E=T.filter(e=>!e.plantable&&!ee(e)&&!re.has(e.id)),D=ie.length?ie:ne,k=[],ce=(n,r,i)=>{if(!n||!S(r,i))return!1;x.add(`${r},${i}`);let o={id:`pl_dev_${e}_${r}_${i}`,worldId:a,playerId:t,objectId:n.id,area:e,x:r,y:i,placedAt:_};return n.plantable&&(o.plantedAt=_),k.push(o),!0},A=(e,t,n,r,i)=>{if(!e.length)return;let a=v()<.65?b(e):null;for(let o=0,s=0;o<r&&s<r*8;s++){let r=a&&v()<.7?a:b(e);ce(r,t+y(-i,i),n+y(-i,i))&&o++}};for(let e=0,t=y(8,12);e<t;e++){let e=y(2,d),t=y(m,h),n=v();n<.4&&ne.length?A(ne,e,t,y(4,8),2):n<.72&&te.length?(A(te,e,t,y(2,4),2),A(D,e,t,y(1,3),2)):A(D,e,t,y(3,6),2)}if(ae.length)for(let e=0,t=y(1,2);e<t;e++){let e=b(ae),t=v()<.5,n=y(4,6),r=y(2,Math.max(2,d-(t?n:0))),i=y(m,Math.max(m,h-(t?0:n)));for(let a=0;a<n;a++)ce(e,r+(t?a:0),i+(t?0:a))}for(let e=0,t=0,n=y(14,20);E.length&&e<n&&t<n*12;t++)ce(b(E),y(2,d),y(m,h))&&e++;for(let e=0;k.length<34&&e<500;e++)ce(b(T),y(2,d),y(m,h));for(let n of C)await l.TerrainTile.put({id:`${a}:${e}:${n.x}:${n.y}`,worldId:a,playerId:t,area:e,x:n.x,y:n.y,type:`water`,updatedAt:Date.now()});for(let e of k)await l.Placement.put(e);let le=C.length,ue=k.length,j=u.animals.filter(t=>t.biome===e),de=new Set((await F(l.Discovery,a)).filter(t=>t.biomeId===e).map(e=>e.animalId));for(let n of j)de.has(n.id)||await l.Discovery.put({id:`${a}:${n.id}`,worldId:a,playerId:t,animalId:n.id,biomeId:e,comfort:90,timesObserved:0,firstObservedAt:Date.now(),whyReturned:Gt(n,u)});await X(a,t,e,{player:f});let M=await pe(l.BiomeState,a,e);await l.BiomeState.patch(M?.id??`${a}:${e}`,{health:100,balance:100,returnedCount:j.length});for(let t of(await F(l.Discovery,a)).filter(t=>t.biomeId===e))await l.Discovery.patch(t.id,{comfort:90});p.push(`Populated ${r.name}: ${ue} objects, ${le} water tiles, ${j.length} animals home, health 100`);break}case`set-weather`:{let e=o&&typeof o==`object`?o:null;if(!e||e.clear){await l.Player.patch(t,{devWeather:null}),p.push(`Weather override cleared — back to the live sky`);break}let r=f.devWeather||{},i={type:r.type??null,season:r.season??null};if(`type`in e){if(e.type&&!d.includes(e.type))throw new O(n(`server.err.unknownWeatherType`,{type:e.type}));i.type=e.type||null}if(`season`in e){if(e.season&&!g.includes(e.season))throw new O(n(`server.err.unknownSeason`,{season:e.season}));i.season=e.season||null}await l.Player.patch(t,{devWeather:i}),p.push(`Weather override: ${i.type||`live`} · ${i.season||`live`}`);break}default:throw new O(n(`server.err.unknownDevAction`,{action:r}))}return{ok:!0,log:p,state:await Sn(t)}}},Fr=4e3,Ir=class extends ${async post(e){let t=await Z(e),r=String(t.message||``).trim();if(!r)throw new O(n(`server.err.feedbackEmpty`));if(r.length>Fr)throw new O(n(`server.err.feedbackTooLong`,{max:Fr}));let i=String(t.replyTo||``).trim().slice(0,200)||null;if(i&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))throw new O(n(`server.err.feedbackBadEmail`));let a=t.metrics&&typeof t.metrics==`object`&&!Array.isArray(t.metrics)?t.metrics:{},o=Number(t.queuedAt)||null,s=`fb_${Date.now()}_${Math.random().toString(36).slice(2,10)}`;return await D().Feedback.put({id:s,message:r,replyTo:i,metrics:a,queuedAt:o,createdAt:Date.now()}),{ok:!0,id:s}}},Lr=class extends Resource{async get(){let e=await M(D().Feedback);return e.sort((e,t)=>(t.createdAt||0)-(e.createdAt||0)),{count:e.length,feedback:e}}},Rr=24e3,zr=class extends ${async post(e){let t=await Z(e),r=String(t.clientId||``).trim().slice(0,64);if(!r)throw new O(n(`server.err.clientIdRequired`));let i=t.snapshot&&typeof t.snapshot==`object`&&!Array.isArray(t.snapshot)?t.snapshot:null;if(!i)throw new O(n(`server.err.snapshotRequired`));let a=JSON.stringify(i);if(a.length>Rr)throw new O(n(`server.err.snapshotTooLarge`));let o=D(),s=`solo:${r}`,c=await j(o.SoloMetrics,s);return await o.SoloMetrics.put({id:s,clientId:r,name:String(t.name||i.name||``).slice(0,40),platform:String(t.platform||``).slice(0,20)||null,os:String(t.os||``).slice(0,20)||null,version:String(t.version||``).slice(0,24)||null,build:String(t.build||``).slice(0,40)||null,language:String(t.language||i.language||``).trim().toLowerCase().slice(0,12)||null,snapshot:a,createdAt:c?.createdAt||Date.now(),updatedAt:Date.now()}),Or=null,{ok:!0}}},Br=class extends ${async post(e){let t=await Z(e),r=String(t.deviceId||``).trim().slice(0,64);if(!r)throw new O(n(`server.err.deviceIdRequired`));let i=t.phase===`created`?`created`:t.phase===`demo_done`?`demo_done`:`open`,a=Date.now(),o=D(),s=`dev:${r}`,c=await j(o.AppOpen,s),l=k(Math.round(Number(t.creationMs)||0),0,36e5);return await o.AppOpen.put({id:s,deviceId:r,platform:String(t.platform||``).slice(0,20)||c?.platform||null,os:String(t.os||``).slice(0,20)||c?.os||null,version:String(t.version||``).slice(0,24)||c?.version||null,edition:t.edition===`demo`||c?.edition===`demo`?`demo`:t.edition===`full`?`full`:c?.edition||null,language:String(t.language||``).trim().toLowerCase().slice(0,12)||c?.language||null,firstOpenAt:c?.firstOpenAt||a,lastOpenAt:a,opens:(c?.opens||0)+ +(i===`open`),converted:c?.converted||i===`created`,firstConvertedAt:c?.firstConvertedAt||(i===`created`?a:0),savesCreated:(c?.savesCreated||0)+ +(i===`created`),creationMs:i===`created`&&l>0?l:c?.creationMs||0,reachedDemoGoal:c?.reachedDemoGoal||i===`demo_done`,demoGoalAt:c?.demoGoalAt||(i===`demo_done`?a:0),updatedAt:a}),Or=null,{ok:!0}}},Vr=e=>({status:200,headers:{"content-type":`text/html; charset=utf-8`,"cache-control":`public, max-age=3600`},body:e}),Hr=class extends ${async get(){return Vr(x)}},Ur=class extends ${async get(){return Vr(S)}},Wr=class extends ${async get(){return Vr(C)}},Gr=class extends ${async get(){return Vr(w)}};export{Br as AppOpen,wr as AppendFeed,Nr as BiomeSnapshot,Nn as ChangePasscode,Bn as CheckWorldCode,Zn as ChestTransfer,yr as ClaimTask,Xn as CollectResource,$n as CraftItem,kn as CreatePlayer,Ln as CreateWorld,jn as DeleteDemoSave,An as DeletePlayer,Pr as DevTools,Qn as DiscardItem,Mn as ExportDemoSave,On as GameData,Fn as GameState,or as HarvestPlacement,Dr as Heartbeat,Hn as JoinRequestStatus,zn as JoinWorld,qn as LeaveWorld,Lr as ListFeedback,Pn as LoginPlayer,Mr as Metrics,cr as MoveObject,In as MyWorlds,vr as ObserveAnimal,Un as PendingJoinRequests,rr as PlaceObject,ir as Plant,Yn as Presence,Sr as RecalcBiome,lr as RemoveObject,Vn as RequestJoin,Wn as ResolveJoin,pr as Rest,br as SetGoals,hr as SetHomeColors,_r as SetHomeStyle,gr as SetPlacementColor,Ir as SubmitFeedback,Kn as SwitchWorld,zr as SyncMetrics,Cr as SyncPlayer,xr as Terraform,sr as UpdateAppearance,dr as UpgradeHome,ur as UpgradeTool,Dn as Version,Gn as WorldRoster,Ur as"age-rating",Gr as dashboard,jt as healthCapForReturns,Hr as privacy,Wr as support};